...
<?php echo \Illuminate\View\Factory::parentPlaceholder('loan_css'); ?>
<style>
    .lm-dashboard {
        display: flex;
...
<div class="lm-dashboard">
    ...
    <section class="lm-dashboard-hero">
        <div class="lm-dashboard-hero-grid">
            ...
            <div class="lm-hero-metrics">
                <?php $__currentLoopData = $heroMetrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="lm-hero-metric">
                        <span class="lm-hero-metric-label"><?php echo e($metric['label'], false); ?></span>
                        <span class="lm-hero-metric-value"><?php echo e($metric['format'] === 'money' ? number_format((float) $metric['value'], 2) : (int) $metric['value'], false); ?></span>
                    </div>
    ...
    <section class="lm-dashboard-cards">
        <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $val = $quickCards[$card['key']] ?? 0; ?>
            <article class="lm-stat-card">
                <span class="lm-stat-card__icon lm-tone-<?php echo e($card['tone'], false); ?>"><i class="<?php echo e($card['icon'], false); ?>"></i></span>
                <div>
                    <span class="lm-stat-card__label"><?php echo e($card['label'], false); ?></span>
                    <span class="lm-stat-card__value" data-loan-card="<?php echo e($card['key'], false); ?>" data-format="<?php echo e(in_array($card['key'], ['collection_amount_today']) ? 'money' : 'int', false); ?>"><?php echo e(in_array($card['key'], ['collection_amount_today']) ? number_format((float) $val, 2) : (int) $val, false); ?></span>
    ...
    <section class="lm-dashboard-grid">
        ...
        <div class="lm-dashboard-panel lm-dashboard-panel--feature">
            <div class="lm-dashboard-panel__header">
                ...
                <span class="lm-dashboard-panel__badge"><i class="fa fa-comments"></i> <?php echo e($dashboardUnreadChats, false); ?> unread</span>
            </div>
            <div class="lm-dashboard-panel__body">
                <div class="lm-chat-card">
                    <div class="lm-chat-card__toolbar">
                        ...
                        <div class="lm-chat-card__actions">
                            ...
                            <?php if(Route::has('loan-management.chat.index')): ?>
                                <a href="<?php echo e(route('loan-management.chat.index'), false); ?>" class="lm-chat-card__icon" title="Open Messenger style inbox">
                    ...
                    <div class="lm-chat-card__summary">
                        <div class="lm-chat-card__summary-box">
                            ...
                            <span class="lm-chat-card__summary-value"><?php echo e($dashboardUnreadChats, false); ?></span>
                        ...
                        <div class="lm-chat-card__summary-box">
                            ...
                            <span class="lm-chat-card__summary-value"><?php echo e($dashboardPendingVisits, false); ?></span>
                    ...
                    <div class="lm-chat-card__list">
                        <div class="lm-chat-card__request">
                            ...
                            <div>
                                ...
                                <p class="lm-chat-card__request-subtitle">
                                    <?php echo e($dashboardUnreadChats > 0 ? $dashboardUnreadChats.' unread customer chat(s) waiting for reply.' : 'No unread customer chats right now.', false); ?>
                        ...
                        <?php if(!empty($recentChats)): ?>
                            <?php $__currentLoopData = $recentChats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <a href="<?php echo e($chatUrl, false); ?>" class="lm-chat-card__item">
                                    <span class="lm-chat-card__avatar-wrap">
                                        <span class="lm-chat-card__avatar"><?php echo e($avatarSeed, false); ?></span>
                                        <span class="lm-chat-card__presence"></span>
                                    </span>
                                    <span>
                                        <span class="lm-chat-card__name"><?php echo e(\Illuminate\Support\Str::limit($chatName, 34), false); ?></span>
                                        <span class="lm-chat-card__preview">
                                            <?php echo e(\Illuminate\Support\Str::limit($previewText, 60), false); ?>

                                            <span class="lm-chat-card__time">&middot; <?php echo e($timeText, false); ?></span>
                                        </span>
                                    </span>
                                    <?php if(($chat['unread_count'] ?? 0) > 0): ?>
                                        <span class="lm-chat-card__dot" title="<?php echo e((int) $chat['unread_count'], false); ?> unread"></span>
                                    <?php else: ?>
                                        <span></span>
                                    <?php endif; ?>
                                </a>
                        ...
                        <?php else: ?>
                            <div class="lm-chat-card__empty">
                                <p style="margin:0 0 12px;">
                                    <?php echo e($dashboardPendingVisits > 0 ? $dashboardPendingVisits.' pending collection visit(s) still need follow-up.' : 'No recent customer chats yet. Open the inbox to start a conversation.', false); ?>

                                </p>
                                <?php if(Route::has('loan-management.chat.index')): ?>
                                    <a href="<?php echo e(route('loan-management.chat.index'), false); ?>" class="btn btn-primary btn-sm">
            ...
            <div class="lm-dashboard-panel">
                ...
                <div class="lm-dashboard-panel__body lm-table-wrap">
                    <table class="table table-condensed lm-dashboard-table lm-mini-table" id="loanOverdueCustomersTable">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = ($overdueCustomers ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><span class="lm-row-title"><?php echo e($row['customer'] ?? '-', false); ?></span></td>
                                <td><?php echo e((int)($row['overdue_days'] ?? 0), false); ?></td>
                                <td class="text-right"><?php echo e(number_format((float)($row['overdue_amount'] ?? 0), 2), false); ?></td>
                            </tr>
                ...
                <div class="lm-dashboard-panel__body">
                    <div class="lm-chart-shell">
                        <div class="lm-chart-copy">
                            ...
                            <small id="loanStatusChartText" data-loan-chart="loan_status">Status labels: <?php echo e(implode(', ', $loanStatusChart['labels'] ?? []), false); ?></small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="lm-dashboard-panel">
            ...
            <div class="lm-dashboard-panel__body lm-table-wrap">
                <table class="table table-bordered table-condensed lm-dashboard-table" id="loanVisitScheduleTable">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = ($visitSchedule ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><span class="lm-row-title"><?php echo e($row['customer'] ?? '-', false); ?></span></td>
                            <td><?php echo e($row['follow_up_date'] ?? '-', false); ?></td>
                            <td><?php echo e($row['status'] ?? '-', false); ?></td>
                            <td><?php echo e($row['assigned_staff'] ?? '-', false); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="lm-dashboard-panel">
            ...
            <div class="lm-dashboard-panel__body lm-table-wrap">
                <table class="table table-striped table-bordered lm-dashboard-table" id="loanCollectorPerformanceTable">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = ($collectorPerformance ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><span class="lm-row-title"><?php echo e($row['collector'] ?? '-', false); ?></span></td>
                            <td><?php echo e((int)($row['assigned_loans'] ?? 0), false); ?></td>
                            <td class="text-right"><?php echo e(number_format((float)($row['collected_amount'] ?? 0), 2), false); ?></td>
                            <td><?php echo e((int)($row['visit_count'] ?? 0), false); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="lm-live-chat-shell">
                    ...
                    <main class="lm-live-chat-main">
                        <div class="lm-live-chat-mainbar">
                            <div>
                                <h4 class="lm-live-chat-main-title" id="loanDashboardLiveChatTitle"><?php echo e($initialLiveChat['display_name'] ?? 'Select a chat', false); ?></h4>
                                <p class="lm-live-chat-main-subtitle" id="loanDashboardLiveChatSubtitle"><?php echo e($initialLiveChat['display_subtitle'] ?? 'Open a customer conversation from the inbox list.', false); ?></p>
                            </div>
                            <div class="lm-live-chat-main-actions">
                            <a href="<?php echo e(route('loan-management.live-chat'), false); ?>" class="btn btn-default btn-sm">
                                <i class="fa fa-external-link"></i> Open Full Inbox
                            </a>
                            <?php if(!empty($initialLiveChat['id'])): ?>
                                <a href="<?php echo e(route('loan-management.live-chat.detail', $initialLiveChat['id']), false); ?>" class="btn btn-primary btn-sm" id="loanDashboardLiveChatOpenBtn">
                                    <i class="fa fa-comments"></i> Open Conversation
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('loan-management.live-chat'), false); ?>" class="btn btn-primary btn-sm" id="loanDashboardLiveChatOpenBtn">
                                        <i class="fa fa-comments"></i> Open Conversation
                                    </a>
                                <?php endif; ?>
                            </div>
                        ...
                        <iframe
                            ...
                            src="<?php echo e(!empty($initialLiveChat['id']) ? route('loan-management.live-chat.detail', ['thread' => $initialLiveChat['id'], '_lm_embed' => 1]) : route('loan-management.live-chat', ['_lm_embed' => 1]), false); ?>"
                    ...
                    <aside class="lm-live-chat-side">
                        <div class="lm-live-chat-profile">
                            <div class="lm-live-chat-profile-avatar" id="loanDashboardLiveChatProfileAvatar">
                                <?php echo e(strtoupper(substr((string) ($initialLiveChat['display_name'] ?? 'C'), 0, 1)), false); ?>

                            </div>
                            <h4 class="lm-live-chat-profile-name" id="loanDashboardLiveChatProfileName"><?php echo e($initialLiveChat['display_name'] ?? 'Customer Chat', false); ?></h4>
                            <p class="lm-live-chat-profile-subtitle" id="loanDashboardLiveChatProfileSubtitle"><?php echo e($initialLiveChat['display_subtitle'] ?? 'Loan support inbox', false); ?></p>
                            <p class="lm-live-chat-profile-time" id="loanDashboardLiveChatProfileTime">
                                <?php echo e(!empty($initialLiveChat['last_message_at']) ? \Carbon\Carbon::parse($initialLiveChat['last_message_at'])->diffForHumans() : 'Waiting for live activity', false); ?>
                        ...
                        <div class="lm-live-chat-side-section">
                            ...
                            <div class="lm-live-chat-side-row"><span>Status</span><span id="loanDashboardLiveChatStatus"><?php echo e(ucfirst((string) ($initialLiveChat['status'] ?? 'open')), false); ?></span></div>
                            <div class="lm-live-chat-side-row"><span>Priority</span><span id="loanDashboardLiveChatPriority"><?php echo e(ucfirst((string) ($initialLiveChat['priority'] ?? 'normal')), false); ?></span></div>
                            <div class="lm-live-chat-side-row"><span>Assigned Team</span><span id="loanDashboardLiveChatTeam"><?php echo e($initialLiveChat['assigned_team'] ?? 'Support', false); ?></span></div>
                            <div class="lm-live-chat-side-row"><span>Unread</span><span id="loanDashboardLiveChatUnread"><?php echo e((int) ($initialLiveChat['unread_count'] ?? 0), false); ?></span></div>
                        </div>
                        ...
                        <div class="lm-live-chat-side-section">
                            ...
                            <div id="loanDashboardLiveChatLastMessage" style="color:#334155; font-size:13px; line-height:1.6;">
                                <?php echo e($initialLiveChat['last_message'] ?? 'No recent message yet.', false); ?>
...
<?php echo \Illuminate\View\Factory::parentPlaceholder('loan_js'); ?>
<script>
    (function ($) {
        if (!window.jQuery) {
            return;
        ...
        var liveUrl = "<?php echo e(route('loan-management.dashboard.data', [], true), false); ?>";
        var quickSearchUrl = "<?php echo e(route('loan-management.dashboard.quick-search', [], true), false); ?>";
        var refreshMs = 30000;
        var loading = false;
        var timer = null;
        ...
        var liveChatThreads = [];
        var activeLiveChatId = <?php echo e((int) ($initialLiveChat['id'] ?? 0), false); ?>;
        var liveChatApiUrl = "<?php echo e(route('loan-management.chat-api.index'), false); ?>";
        var liveChatFrameBaseUrl = "<?php echo e(url('loan-management/live-chat'), false); ?>";
        ...
        function renderQuickSearch(rows) {
            var html = '';
            (rows || []).forEach(function (row) {
                var detailUrl = "<?php echo e(url('loan-management/loans'), false); ?>/" + row.id + "/view?_lm_modal=1";
                var editUrl = "<?php echo e(url('loan-management/loans'), false); ?>/" + row.id + "/edit?_lm_modal=1";
                var printModalUrl = "<?php echo e(url('loan-management/loans'), false); ?>/" + row.id + "/print-modal";
                var payUrl = "<?php echo e(url('loan-management/loans'), false); ?>/" + row.id + "/payment/create?return_to=<?php echo e(rawurlencode(route('loan-management.dashboard')), false); ?>";
                html += '<tr>'
        ...
        function renderSellSearch(rows) {
            var html = '';
            (rows || []).forEach(function (row) {
                var addUrl = "<?php echo e(url('loan-management/loans/sell'), false); ?>/" + row.id + "/clone";
                var detailUrl = "<?php echo e(action([\App\Http\Controllers\SellController::class, 'show'], ['__ROW_ID__']), false); ?>".replace('__ROW_ID__', encodeURIComponent(row.id));
                var viewLoanUrl = row.linked_loan_id ? "<?php echo e(url('loan-management/loans'), false); ?>/" + row.linked_loan_id + "/view?_lm_modal=1" : '';
                html += '<tr>'
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules\LoanManagement\Providers/../Resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>