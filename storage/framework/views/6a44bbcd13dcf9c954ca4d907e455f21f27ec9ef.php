...
<section class="content-header">
    ...
    <a class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm pull-right tw-mt-4" href="<?php echo e(action([\Modules\Service\Http\Controllers\Install\ModulesController::class, 'regenerate']), false); ?>">
...
<div class="row">
    <div class="col-md-12 form_col" style="display: none;">
        <?php $__env->startComponent('service::components.widget'); ?>
            <?php echo Form::open(['url' => action([\Modules\Service\Http\Controllers\Install\ModulesController::class, 'uploadModule']), 'id' => 'upload_module_form','files' => true, 'style' => 'display:none']); ?>
            ...
            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form 
                            action="<?php echo e(action([\Modules\Service\Http\Controllers\Install\ModulesController::class, 'destroy'], ['module_name' => $module['name']]), false); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('service::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Service\Resources/views/install/modules/index.blade.php ENDPATH**/ ?>