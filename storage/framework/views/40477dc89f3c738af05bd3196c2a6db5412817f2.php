...
<?php
    ...
    $isServiceRoute = $request->segment(1) == $routePrefix;
    $firstSegment = $isServiceRoute ? $request->segment(2) : $request->segment(1);
    $secondSegment = $isServiceRoute ? $request->segment(3) : $request->segment(2);
    $thirdSegment = $isServiceRoute ? $request->segment(4) : $request->segment(3);
    $isCustomerDisplay = $firstSegment == 'customer-display';
?>

<?php if(
    $firstSegment == 'pos' &&
        ($secondSegment == 'create' || $thirdSegment == 'edit' || $secondSegment == 'payment')): ?>
    <?php
        $pos_layout = true;
    ?>
<?php else: ?>
...
<head>
    ...
    <?php echo $__env->make('service::layouts.partials.css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    

    <?php echo $__env->make('service::layouts.partials.extracss', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<body
    ...
    <div class="tw-flex thetop">
        ...
        <?php if(!$pos_layout && !$isCustomerDisplay): ?>
            <?php echo $__env->make('service::layouts.partials.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        ...
        <main class="tw-flex tw-flex-col tw-flex-1 tw-h-full tw-min-w-0 tw-bg-gray-100">
            <?php if(!$isCustomerDisplay && !$pos_layout): ?>
                <?php echo $__env->make('service::layouts.partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php elseif(!$isCustomerDisplay): ?>
                <?php echo $__env->make('service::layouts.partials.header-pos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
            <!-- empty div for vuejs -->
            <div id="app">
            ...
            <div class="tw-flex-1 tw-overflow-y-auto tw-h-screen" id="scrollable-container">
                ...
                <?php if(!$pos_layout): ?>
                    ...
                    <?php echo $__env->make('service::layouts.partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php else: ?>
                    <?php echo $__env->make('service::layouts.partials.footer_pos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            </div>
        ...
        <?php echo $__env->make('service::home.todays_profit_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- /.content-wrapper -->



        <audio id="success-audio">
            <source src="<?php echo e(asset('/audio/success.ogg?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>" type="audio/ogg">
            <source src="<?php echo e(asset('/audio/success.mp3?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>" type="audio/mpeg">
        </audio>
        <audio id="error-audio">
            <source src="<?php echo e(asset('/audio/error.ogg?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>" type="audio/ogg">
            <source src="<?php echo e(asset('/audio/error.mp3?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>" type="audio/mpeg">
        </audio>
        <audio id="warning-audio">
            <source src="<?php echo e(asset('/audio/warning.ogg?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>" type="audio/ogg">
            <source src="<?php echo e(asset('/audio/warning.mp3?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>" type="audio/mpeg">
        </audio>
        ...
        <?php echo $__env->make('service::layouts.partials.javascripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        
        
        <?php echo $__env->make('service::layouts.module-assets', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Service\Resources/views/layouts/app.blade.php ENDPATH**/ ?>