...
<?php $__env->startSection('javascript'); ?>
    <?php echo $__env->make('service::home.partials.home_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script src="<?php echo e(asset('modules/service/v7/js/payment.js?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>"></script>
    <?php if ($__env->exists('service::sales_order.common_js')) echo $__env->make('service::sales_order.common_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php if ($__env->exists('service::purchase_order.common_js')) echo $__env->make('service::purchase_order.common_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php if(!empty($all_locations)): ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            sales_order_table = $('#sales_order_table').DataTable({
                ...
                "ajax": {
                    "url": '<?php echo e(action([\Modules\Service\Http\Controllers\SellController::class, 'index']), false); ?>?sale_type=sales_order',
                    "data": function(d) {
            ...
            <?php if(auth()->user()->can('account.access') && config('constants.show_payments_recovered_today') == true): ?>
                ...
                cash_flow_table = $('#cash_flow_table').DataTable({
                    ...
                    fixedHeader:false,
                    "ajax": {
                        "url": "<?php echo e(action([\Modules\Service\Http\Controllers\AccountController::class, 'cashFlow']), false); ?>",
                        "data": function(d) {
                            d.type = 'credit';
            ...
            <?php if(!empty($common_settings['enable_purchase_order'])): ?>
                ...
                purchase_order_table = $('#purchase_order_table').DataTable({
                    ...
                    scrollCollapse: true,
                    ajax: {
                        url: '<?php echo e(action([\Modules\Service\Http\Controllers\PurchaseOrderController::class, 'index']), false); ?>',
                        data: function(d) {
            ...
            <?php if(!empty($common_settings['enable_purchase_requisition'])): ?>
                ...
                purchase_requisition_table = $('#purchase_requisition_table').DataTable({
                    ...
                    scrollCollapse: true,
                    ajax: {
                        url: '<?php echo e(action([\Modules\Service\Http\Controllers\PurchaseRequisitionController::class, 'index']), false); ?>',
                        data: function(d) {
                            d.from_dashboard = true;
            ...
            sell_table = $('#shipments_table').DataTable({
                ...
                scrollCollapse: true,
                "ajax": {
                    "url": '<?php echo e(action([\Modules\Service\Http\Controllers\SellController::class, 'index']), false); ?>',
                    "data": function(d) {
...
<?php echo $__env->make('service::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Service\Resources/views/home/index.blade.php ENDPATH**/ ?>