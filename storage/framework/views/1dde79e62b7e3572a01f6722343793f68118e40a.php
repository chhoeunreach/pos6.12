  ...
  <div class="box box-solid">
    ...
    <input type="hidden" name="sub_type" value="<?php echo e($sub_type, false); ?>">
      <div class="row">
        ...
        <?php endif; ?>
        <div class="col-sm-8 col-sm-offset-2">
          <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white pull-right"><?php echo app('translator')->get('cash_register.open_register'); ?></button>
        </div>
        <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\resources\views/cash_register/create.blade.php ENDPATH**/ ?>