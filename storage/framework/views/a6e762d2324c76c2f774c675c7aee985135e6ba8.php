    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                        ...
                        <div class="row">
                            <div id="payment_rows_div">
                                ...
                                <?php $__currentLoopData = $payment_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php echo $__env->make('service::sale_pos.partials.payment_row', [
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm tw-w-full"
                                    id="add-payment-row"><?php echo app('translator')->get('sale.add_payment_row'); ?></button>
                            </div>
                        </div>
                        <br>
                        <div class="row <?php if($change_return['amount'] == 0): ?> hide <?php endif; ?> payment_row"
                            ...
                            <div class="col-md-12">
                                <div class="box box-solid payment_row bg-lightgray">
                                    <div class="box-body">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    ?>
                                                    <?php echo Form::select('payment[change_return][method]', $_payment_types, $_payment_method, [
                                        ...
                                        <?php echo $__env->make('service::sale_pos.partials.payment_type_details', [
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::textarea('sale_note', !empty($transaction) ? $transaction->additional_notes : null, [
                                        'class' => 'form-control',
                                        'rows' => 3,
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::textarea('staff_note', !empty($transaction) ? $transaction->staff_note : null, [
                                        'class' => 'form-control',
                                        'rows' => 3,
                        ...
                        <div class="box box-solid bg-orange">
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <?php echo Form::hidden('change_return', $change_return['amount'], [
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white" id="pos-save"><?php echo app('translator')->get('sale.finalize_payment'); ?></button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="card_details_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php echo Form::select('', ['visa' => 'Visa', 'master' => 'MasterCard'], 'visa', [
            ...
            <div class="modal-footer">
                <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white" id="pos-save-card"><?php echo app('translator')->get('sale.finalize_payment'); ?></button>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Service\Resources/views/sale_pos/partials/payment_modal.blade.php ENDPATH**/ ?>