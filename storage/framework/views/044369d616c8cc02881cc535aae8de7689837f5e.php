...
<?php endif; ?>
    ...
    <div class="lm-chat-shell<?php echo e($isEmbedded ? ' lm-chat-shell--embedded' : '', false); ?>" id="lmChatApp">
        <?php if(! $isEmbedded): ?>
...
<script>
(function($){
    var activeThread = <?php echo json_encode($initialThreadId ?? null, 15, 512) ?>;
    var activeView = 'all';
    var isEmbedded = <?php echo json_encode($isEmbedded, 15, 512) ?>;
    var threads = [];
    var csrf = '<?php echo e(csrf_token(), false); ?>';
    var chatBaseUrl = '<?php echo e(url('loan-management/chat-api/chats'), false); ?>';
    var pollMs = <?php echo e((int) config('loanmanagement.chat_polling_seconds', 5) * 1000, false); ?>;
...
<?php echo $__env->make('loanmanagement::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules\LoanManagement\Providers/../Resources/views/chat/inbox.blade.php ENDPATH**/ ?>