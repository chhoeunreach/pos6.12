	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white" id="posEditOrderTaxModalUpdate"><?php echo app('translator')->get('messages.update'); ?></button>
...
</div><!-- /.modal --><?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Service\Resources/views/sale_pos/partials/edit_order_tax_modal.blade.php ENDPATH**/ ?>