...
<head>
    <meta charset="utf-8">
    <title>Print Loan <?php echo e($loanRow->loan_number ?? $loanRow->id, false); ?></title>
    <style>
...
<div class="page">
    <div class="header">
        <div class="brand-row">
            <div class="logo-wrap">
                <?php if(! empty($logo)): ?>
                    <img class="logo" src="<?php echo e($logo, false); ?>" alt="logo" onerror="this.style.display='none'">
                <?php endif; ?>
            </div>
    ...
    <div class="info-grid">
        <table class="info-table">
            <tr><td class="label">លេខកិច្ចសន្យា</td><td class="value red"><?php echo e($loanRow->loan_number ?? $loanRow->id, false); ?></td></tr>
            <tr><td class="label">Invoice No</td><td class="value"><?php echo e($sourceInvoiceDisplay ?? '-', false); ?></td></tr>
            <tr><td class="label">កាលបរិច្ឆេទខ្ចីប្រាក់</td><td class="value"><?php echo e($loanDate, false); ?></td></tr>
            <tr><td class="label">កាលបរិច្ឆេទបញ្ចប់</td><td class="value"><?php echo e($lastDueDate ? \Carbon\Carbon::parse($lastDueDate)->format('m-d-Y') : '-', false); ?></td></tr>
        </table>
        <table class="info-table">
            <tr><td class="label">ឈ្មោះអតិថិជន</td><td class="value"><?php echo e($customer->name ?? '-', false); ?></td></tr>
            <tr><td class="label">លេខទូរស័ព្ទ</td><td class="value"><?php echo e($customer->mobile ?? '-', false); ?></td></tr>
            <tr><td class="label">លេខសម្គាល់</td><td class="value"><?php echo e($customer->custom_field1 ?? '-', false); ?></td></tr>
        </table>
        <table class="info-table">
            <tr><td class="label">កាលបរិច្ឆេទទី១</td><td class="value"><?php echo e($firstDueDate ? \Carbon\Carbon::parse($firstDueDate)->format('m-d-Y') : '-', false); ?></td></tr>
            <tr><td class="label">អ្នករួមខ្ចី</td><td class="value"><?php echo e($customer->co_borrower ?? '-', false); ?></td></tr>
            <tr><td class="label">លេខអ្នករួមខ្ចី</td><td class="value"><?php echo e($customer->co_borrower_phone ?? '-', false); ?></td></tr>
        </table>
    </div>
    <div class="address-row">
        <span class="blue-label">អាសយដ្ឋាន</span>
        <span class="bold"><?php echo e($customer->address_line_1 ?? '-', false); ?></span>
    </div>
    ...
    <table class="print-table product-table">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                ?>
                <tr>
                    <td class="bold"><?php echo e($i + 1, false); ?></td>
                    <td class="bold"><?php echo e($p->product_sku ?? '-', false); ?></td>
                    <td class="text-left bold">
                        <?php echo e($p->product_name ?? '-', false); ?>

                        <?php if($showImei): ?> / IMEI: <?php echo e($imei, false); ?> <?php endif; ?>
                        <?php if($showSerial): ?> / Serial: <?php echo e($serial, false); ?> <?php endif; ?>
                    </td>
                    <td class="bold"><?php echo e(number_format($qty, 0), false); ?></td>
                    <td colspan="2" class="money-cell bold">$<?php echo e(number_format($price, 2), false); ?></td>
                    <td colspan="2" class="money-cell bold">$<?php echo e(number_format($subtotal, 2), false); ?></td>
                </tr>
                        ...
                        <tr>
                            <td class="summary-terms-cell">
                                <table class="summary-terms">
                                    <tr>
                                        <td>រយៈពេលបង់(ខែ)</td>
                                        <td class="term-value"><?php echo e($duration, false); ?></td>
                                    </tr>
                                    <tr>
                                        <td>ភាគរយបង់មុន</td>
                                        <td class="term-value"><?php echo e(number_format($downPercent, 2), false); ?>%</td>
                                    </tr>
                                    <tr>
                                        <td>អត្រាការប្រាក់</td>
                                        <td class="term-value red"><?php echo e(number_format($interestRate, 2), false); ?>%</td>
                                    </tr>
                                </table>
                            </td>
                            <td class="summary-totals-cell">
                                <table class="summary-totals">
                                    <tr>
                                        ...
                                        <td class="summary-amount"><?php echo e(number_format($productTotal, 2), false); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="summary-total-label">
                                            ប្រាក់ចូលរួមមុន
                                            <?php if($downPaymentLines->isNotEmpty()): ?>
                                                <span class="summary-method-line"><?php echo $downPaymentLines->implode(' '); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="summary-currency">$</td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" class="summary-amount red">$<?php echo e(number_format($balanceAmount, 2), false); ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
    ...
    <table class="print-table schedule-table" style="margin-top:0;">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $installments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <tr>
                    ...
                    <td class="bold nowrap"><?php echo e($row->installmentdate ? \Carbon\Carbon::parse($row->installmentdate)->format('d-m-Y') : '-', false); ?></td>
                    ...
                    <td class="text-right bold">$ <?php echo e(number_format($rowTotal, 2), false); ?></td>
                    <td class="bold nowrap"><?php echo $paymentDates->implode('<br>'); ?></td>
                    <td class="text-right"><?php echo $paymentLines->implode(' '); ?></td>
                    <td class="text-right"><?php echo e($paid > 0 ? '$ '.number_format($paid, 2) : '', false); ?></td>
                    <td><?php echo e(ucfirst($row->status ?? ''), false); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="signature-row">
        <div class="signature-box">
            ...
            <div class="signature-name"><?php echo e($customer->name ?? '-', false); ?></div>
            <div class="signature-line"></div>
        </div>
        <div class="signature-box">
            <div>ហត្ថលេខាអ្នកផ្ដល់កម្ចី</div>
            <div class="signature-name"><?php echo e($createdBy, false); ?></div>
        </div>
    </div>
    ...
    <div class="payment-area">
        <div class="payment-card">
            ...
            <?php if(! empty($paymentQr)): ?>
                <img src="<?php echo e($paymentQr, false); ?>" class="qr-large" alt="QR payment">
            <?php elseif(file_exists(public_path('img/qr-code-aba.png'))): ?>
                <img src="<?php echo e(asset('img/qr-code-aba.png'), false); ?>" class="qr-large" alt="QR payment">
            <?php else: ?>
        ...
        <div class="payment-card">
            ...
            <?php if(file_exists(public_path('img/payment-method.png'))): ?>
                <img src="<?php echo e(asset('img/payment-method.png'), false); ?>" style="max-width:33mm;max-height:12mm;" alt="Payment methods">
            <?php endif; ?>
            <div style="margin-top:5mm;">
                <span class="caption orange">សូមស្កេន QR Telegram ខាងក្រោម</span><br>
                <?php if(! empty($telegramQr)): ?>
                    <img src="<?php echo e($telegramQr, false); ?>" class="qr-small" alt="Telegram QR">
                <?php elseif(file_exists(public_path('img/telegram-qr.png'))): ?>
                    <img src="<?php echo e(asset('img/telegram-qr.png'), false); ?>" class="qr-small" alt="Telegram QR">
                <?php else: ?>
    ...
    async function copyLoanAsImage() {
        ...
        try {
            ...
            if (navigator.clipboard && window.ClipboardItem) {
                ...
                fallbackLink.download = 'loan-' + <?php echo e(\Illuminate\Support\Js::from((string) ($loanRow->loan_number ?? $loanRow->id)), false); ?> + '.png';
                fallbackLink.click();
...
<?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules\LoanManagement\Providers/../Resources/views/loans/print/loan.blade.php ENDPATH**/ ?>