<script type="text/javascript">
    service_base_path = "<?php echo e(url(config('service.route_prefix', 'service-pos')), false); ?>";
...
<script src="<?php echo e(asset('modules/service/v7/js/vendor.js?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>"></script>

<?php if(file_exists(public_path('js/lang/' . session()->get('user.language', config('app.locale')) . '.js'))): ?>
    <script src="<?php echo e(asset('js/lang/' . session()->get('user.language', config('app.locale')) . '.js?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>">
    </script>
<?php else: ?>
    <script src="<?php echo e(asset('js/lang/en.js?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>"></script>
<?php endif; ?>
<?php
...
<script>
    ...
    function serviceRouteUrl(url, forceAbsolute) {
        ...
        var routePrefix = '/<?php echo e(trim(config('service.route_prefix', 'service-pos'), '/'), false); ?>';
        var skipPrefixes = [
            '/login',
            '/logout',
            '/register',
...
<script src="<?php echo e(asset('modules/service/v7/js/functions.js?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>"></script>
<script>
...
<script src="<?php echo e(asset('modules/service/v7/js/common.js?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>"></script>
<script src="<?php echo e(asset('modules/service/v7/js/app.js?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>"></script>
<script src="<?php echo e(asset('modules/service/v7/js/help-tour.js?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>"></script>
<script src="<?php echo e(asset('modules/service/v7/js/documents_and_note.js?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>"></script>

<!-- TODO -->
<?php if(file_exists(public_path('AdminLTE/plugins/select2/lang/' . session()->get('user.language', config('app.locale')) . '.js'))): ?>
    <script
        src="<?php echo e(asset('AdminLTE/plugins/select2/lang/' . session()->get('user.language', config('app.locale')) . '.js?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>">
    </script>
<?php endif; ?>
<?php
...
<?php if(file_exists(public_path() . '/js/jquery-validation-1.16.0/src/localization/' . $validation_lang_file)): ?>
    <script src="<?php echo e(asset('js/jquery-validation-1.16.0/src/localization/' . $validation_lang_file . '?v=' . $asset_v . '-service-jsfix-20260609'), false); ?>">
    </script>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Service\Resources/views/layouts/partials/javascripts.blade.php ENDPATH**/ ?>