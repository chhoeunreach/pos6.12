<div class="modal-dialog modal-lg" role="document">
  ...
  <?php
    ...
    if(isset($store_action)) {
      ...
      $url = action([\Modules\Service\Http\Controllers\ContactController::class, 'store']);
  ...
  ?>
    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm center-block more_btn" data-target="#more_div"><?php echo app('translator')->get('lang_v1.more_info'); ?> <i class="fa fa-chevron-down"></i></button>
            </div>
          ...
          <div class="col-md-4">
            <div class="form-group">
                <?php echo Form::label('land_mark', __('business.land_mark') . ':'); ?>

                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-map-marker"></i>
                    </span>
                    <?php echo Form::text('land_mark', null, ['class' => 'form-control', 'placeholder' => __('business.land_mark')]); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
                <?php echo Form::label('street_name', __('business.street_name') . ':'); ?>

                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-map-marker"></i>
                    </span>
                    <?php echo Form::text('street_name', null, ['class' => 'form-control', 'placeholder' => __('business.street_name')]); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
                <?php echo Form::label('building_number', __('business.building_number') . ':'); ?>

                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-map-marker"></i>
                    </span>
                    <?php echo Form::text('building_number', null, ['class' => 'form-control', 'placeholder' => __('business.building_number')]); ?>
          ...
          <div class="col-md-4">
            <div class="form-group">
                <?php echo Form::label('additional_number', __('business.additional_number_secondary') . ':'); ?>

                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-map-marker"></i>
                    </span>
                    <?php echo Form::text('additional_number', null, ['class' => 'form-control', 'placeholder' => __('business.additional_number')]); ?>
        ...
        <?php echo $__env->make('service::layouts.partials.module_form_part', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Service\Resources/views/contact/create.blade.php ENDPATH**/ ?>