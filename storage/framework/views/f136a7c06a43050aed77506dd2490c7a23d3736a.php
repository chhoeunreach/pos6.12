...
<body
    class="tw-font-sans tw-antialiased tw-text-gray-900 tw-bg-gray-100 <?php if($request->segment(1) == 'loan-management'): ?> loan-management-page <?php endif; ?> <?php if($pos_layout): ?> hold-transition lockscreen <?php else: ?> hold-transition skin-<?php if(!empty(session('business.theme_color'))): ?><?php echo e(session('business.theme_color'), false); ?><?php else: ?><?php echo e('blue-light', false); ?> <?php endif; ?> sidebar-mini <?php endif; ?>" >
    <div class="tw-flex thetop">
        ...
        <?php if(!$pos_layout && $request->segment(1) != 'customer-display' && $request->segment(1) != 'loan-management'): ?>
...
<?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\resources\views/layouts/app.blade.php ENDPATH**/ ?>