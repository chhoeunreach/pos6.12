...
<?php
    $routePrefix = trim(config('accessory.route_prefix', 'accessory-pos'), '/');
    $isAccessoryRoute = $request->segment(1) == $routePrefix;
    $firstSegment = $isAccessoryRoute ? $request->segment(2) : $request->segment(1);
    $secondSegment = $isAccessoryRoute ? $request->segment(3) : $request->segment(2);
    $thirdSegment = $isAccessoryRoute ? $request->segment(4) : $request->segment(3);
...
<head>
    ...
    <?php echo $__env->make('accessory::layouts.partials.css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    

    <?php echo $__env->make('accessory::layouts.partials.extracss', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<body
    ...
    <div class="tw-flex thetop">
        ...
        <?php if(!$pos_layout && !$isCustomerDisplay): ?>
            <?php echo $__env->make('accessory::layouts.partials.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        ...
        <main class="tw-flex tw-flex-col tw-flex-1 tw-h-full tw-min-w-0 tw-bg-gray-100">
            <?php if(!$isCustomerDisplay && !$pos_layout): ?>
                <?php echo $__env->make('accessory::layouts.partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php elseif(!$isCustomerDisplay): ?>
                <?php echo $__env->make('accessory::layouts.partials.header-pos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
            <!-- empty div for vuejs -->
            <div id="app">
            ...
            <div class="tw-flex-1 tw-overflow-y-auto tw-h-screen" id="scrollable-container">
                ...
                <?php if(!$pos_layout): ?>
                    ...
                    <?php echo $__env->make('accessory::layouts.partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php else: ?>
                    <?php echo $__env->make('accessory::layouts.partials.footer_pos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            </div>
        ...
        <?php echo $__env->make('accessory::home.todays_profit_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- /.content-wrapper -->
        ...
        <?php echo $__env->make('accessory::layouts.partials.javascripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        
        
        <?php echo $__env->make('accessory::layouts.module-assets', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Accessory\Resources/views/layouts/app.blade.php ENDPATH**/ ?>