<div class="row">
	...
	<?php endif; ?>
	<div class="clearfix"></div>
		<?php echo $__env->make('service::sale_pos.partials.payment_type_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<div class="col-md-12">
		<div class="form-group">
...
</div><?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Service\Resources/views/sale_pos/partials/payment_row_form.blade.php ENDPATH**/ ?>