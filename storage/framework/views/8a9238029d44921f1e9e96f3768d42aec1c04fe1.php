<link href="<?php echo e(asset('modules/service/v7/css/tailwind/app.css?v='.$asset_v.'-service-jsfix-20260609'), false); ?>" rel="stylesheet">
...
<link rel="stylesheet" href="<?php echo e(asset('modules/service/v7/css/vendor.css?v='.$asset_v.'-service-jsfix-20260609'), false); ?>">

<?php if( in_array(session()->get('user.language', config('app.locale')), config('constants.langs_rtl')) ): ?>
	<link rel="stylesheet" href="<?php echo e(asset('modules/service/v7/css/rtl.css?v='.$asset_v.'-service-jsfix-20260609'), false); ?>">
<?php endif; ?>

<?php echo $__env->yieldContent('css'); ?>

<!-- app css -->
<link rel="stylesheet" href="<?php echo e(asset('modules/service/v7/css/app.css?v='.$asset_v.'-service-jsfix-20260609'), false); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Service\Resources/views/layouts/partials/css.blade.php ENDPATH**/ ?>