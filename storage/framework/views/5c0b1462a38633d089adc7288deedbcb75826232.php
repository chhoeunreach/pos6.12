<script type="text/javascript">
    $(document).ready(function() {
        ...
        var stock_alert_table = $('#stock_alert_table').DataTable({
            ...
            dom: 'Btirp',
            ajax: {
                url: "<?php echo e(url(config('accessory.route_prefix', 'accessory-pos') . '/home/product-stock-alert'), false); ?>",
                data: function(d) {
        ...
        purchase_payment_dues_table = $('#purchase_payment_dues_table').DataTable({
            ...
            dom: 'Btirp',
            ajax: {
                url: "<?php echo e(url(config('accessory.route_prefix', 'accessory-pos') . '/home/purchase-payment-dues'), false); ?>",
                data: function(d) {
        ...
        sales_payment_dues_table = $('#sales_payment_dues_table').DataTable({
            ...
            dom: 'Btirp',
            ajax: {
                url: "<?php echo e(url(config('accessory.route_prefix', 'accessory-pos') . '/home/sales-payment-dues'), false); ?>",
                data: function(d) {
        ...
        stock_expiry_alert_table = $('#stock_expiry_alert_table').DataTable({
            ...
            dom: 'Btirp',
            ajax: {
                url: "<?php echo e(url(config('accessory.route_prefix', 'accessory-pos') . '/reports/stock-expiry'), false); ?>",
                data: function(d) {
        ...
        if ($('#quotation_table').length) {
            quotation_datatable = $('#quotation_table').DataTable({
                ...
                aaSorting: [[0, 'desc']],
                ajax: {
                    url: "<?php echo e(url(config('accessory.route_prefix', 'accessory-pos') . '/sells/draft-dt?is_quotation=1'), false); ?>",
                    data: function(d) {
    ...
    function update_statistics(start, end) {
        ...
        $.ajax({
            method: 'get',
            url: "<?php echo e(url(config('accessory.route_prefix', 'accessory-pos') . '/home/get-totals'), false); ?>",
            dataType: 'json',
            data: data,
...
<?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Accessory\Resources/views/home/partials/home_js.blade.php ENDPATH**/ ?>