    ...
    <div class="tw-px-5 tw-py-3">
        <div class="tw-flex tw-items-start tw-justify-between tw-gap-6 lg:tw-items-center">
            ...
            <?php if(!empty(session('previous_user_id')) && !empty(session('previous_username'))): ?>
                <a href="<?php echo e(route('accessory.sign-in-as-user', session('previous_user_id')), false); ?>" class="btn btn-flat btn-danger m-8 btn-sm mt-10"><i class="fas fa-undo"></i> <?php echo app('translator')->get('lang_v1.back_to_username', ['username' => session('previous_username')] ); ?></a>
            <?php endif; ?>


            <div class="tw-flex tw-flex-wrap tw-items-center tw-justify-end tw-gap-3">
                <a href="<?php echo e($main_products_url, false); ?>" class="btn btn-primary btn-sm lm-btn-back" data-accessory-skip-rewrite="true">
                ...
                <details class="tw-dw-dropdown tw-relative tw-inline-block tw-text-left">
                    ...
                    <ul class="tw-dw-menu tw-dw-dropdown-content tw-dw-z-[1] tw-dw-bg-base-100 tw-dw-rounded-box tw-w-48 tw-absolute tw-left-0 tw-z-10 tw-mt-2 tw-origin-top-right tw-bg-white tw-rounded-lg tw-shadow-lg tw-ring-1 tw-ring-gray-200 focus:tw-outline-none"
                        ...
                        <div class="tw-p-2" role="none">
                            <a href="<?php echo e(route('accessory.calendar'), false); ?>"
                ...
                <button id="btnCalculator" title="<?php echo app('translator')->get('lang_v1.calculator'); ?>" data-content='<?php echo $__env->make('accessory::layouts.partials.calculator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>'
                ...
                <?php if(in_array('pos_sale', $enabled_modules)): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sell.create')): ?>
                        <a href="/<?php echo e(trim(config('accessory.route_prefix', 'accessory-pos'), '/'), false); ?>/pos/create"
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <?php if(!in_array('Repair', config('accessory.excluded_main_modules', []), true) && Module::has('Repair')): ?>
                ...
                <?php echo $__env->make('accessory::layouts.partials.header-notifications', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <details class="tw-dw-dropdown tw-relative tw-inline-block tw-text-left">
                    ...
                    <ul class="tw-p-2 tw-w-48 tw-absolute tw-right-0 tw-z-10 tw-mt-2 tw-origin-top-right tw-bg-white tw-rounded-lg tw-shadow-lg tw-ring-1 tw-ring-gray-200 focus:tw-outline-none"
                        ...
                        <li>
                            <a href="<?php echo e(action([\Modules\Accessory\Http\Controllers\UserController::class, 'getProfile']), false); ?>"
                                class="tw-flex tw-items-center tw-gap-2 tw-px-3 tw-py-2 tw-text-sm tw-font-medium tw-text-gray-600 tw-transition-all tw-duration-200 tw-rounded-lg hover:tw-text-gray-900 hover:tw-bg-gray-100"
                                role="menuitem" tabindex="-1">
                                <svg aria-hidden="true" class="tw-w-5 tw-h-5" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" fill="none"
                        ...
                        <li>
                            <a href="<?php echo e(action([\Modules\Accessory\Http\Controllers\Auth\LoginController::class, 'logout']), false); ?>"
                                class="tw-flex tw-items-center tw-gap-2 tw-px-3 tw-py-2 tw-text-sm tw-font-medium tw-text-gray-600 tw-transition-all tw-duration-200 tw-rounded-lg hover:tw-text-gray-900 hover:tw-bg-gray-100"
                                role="menuitem" tabindex="-1">
                                <svg aria-hidden="true" class="tw-w-5 tw-h-5" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor" fill="none"
...
<?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\Modules/Accessory\Resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>