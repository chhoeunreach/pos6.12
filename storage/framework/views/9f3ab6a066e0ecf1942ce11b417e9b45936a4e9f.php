            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="productListDetailsModalLabel"><?php echo app('translator')->get('messages.view'); ?></h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label"><?php echo app('translator')->get('sale.product'); ?>:</label>
                            <div id="product_list_details_modal_product" class="tw-font-semibold"></div>
                        </div>
                        <div class="form-group">
                            <label class="control-label"><?php echo app('translator')->get('purchase.business_location'); ?>:</label>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var upos_view_label = <?php echo json_encode(__('messages.view'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\apply like facebook\pos6.12\resources\views/product/index.blade.php ENDPATH**/ ?>