            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('transfer_custom_field_1', $original_transfer->transfer_custom_field_1 ?? null, ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('transfer_custom_field_2', ['' => __('messages.please_select')] + $hr_staff, $original_transfer->transfer_custom_field_2 ?? null, ['class' => 'form-control select2']) !!}
                    </div>
                </div>
            </div>
            <div class="row">
