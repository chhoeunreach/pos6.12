...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    // Disabled: controller not present in this codebase (breaks route:list tooling)
    ...
    Route::get('/reports/stock-sell-report', [ReportController::class, 'stockSellReport']);
    Route::get('/reports/stock-purchase-report', [ReportController::class, 'stockPurchaseReport']);
    ...
    Route::get('/reports/stock-transfer-report', [ReportController::class, 'getStockTransferReport']);
    ...
    Route::get('stock-transfers/{id}/retransfer', [StockTransferController::class, 'retransfer']);
    Route::get('stock-transfers/import-template', [StockTransferController::class, 'downloadImportTemplate']);
    Route::post('stock-transfers/import-lines', [StockTransferController::class, 'importLines']);
...
Route::middleware(['auth'])->group(function () {
    // Keep GET logout for legacy UI links; do not name it "logout" to avoid conflict with Auth::routes logout.
