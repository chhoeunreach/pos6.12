...
<section class="content no-print">
    @component('service::components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_stock_transfers')])
        @slot('tool')
            <div class="box-tools">
                @if(auth()->user()->can('stock_transfer.create'))
                    <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right"
                        href="{{action([\Modules\Service\Http\Controllers\StockTransferController::class, 'create'])}}">
...
@include('service::stock_transfer.partials.update_status_modal')
