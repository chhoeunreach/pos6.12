...
<section class="content no-print">
					...
					<div class="tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] tw-rounded-2xl tw-bg-white" style="padding:0;overflow:hidden;height:100%;">
						<div class="box-body pb-0">
							...
							<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
								@include('service::sale_pos.partials.pos_form_edit')

								@include('service::sale_pos.partials.pos_form_totals', ['edit' => true])
	...
	@include('service::sale_pos.partials.pos_form_actions', ['edit' => true])
	{!! Form::close() !!}
</section>
...
@section('javascript')
	...
	@include('service::sale_pos.partials.pos_layout_script', ['form_id' => 'edit_pos_sell_form'])
