...
@if (isset($transaction))
    @include('service::sale_pos.partials.edit_discount_modal', [
...
@if (isset($transaction))
    @include('service::sale_pos.partials.edit_order_tax_modal', ['selected_tax' => $transaction->tax_id])
@else
    @include('service::sale_pos.partials.edit_order_tax_modal', [
        'selected_tax' => $business_details->default_sales_tax,
    ])
@endif

@include('service::sale_pos.partials.edit_shipping_modal')
