...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 text-right mb-12" >
            ...
            @auth
                <a href="{{action([\Modules\Service\Http\Controllers\SellController::class, 'index'])}}" class="tw-dw-btn tw-dw-btn-success tw-text-white no-print tw-dw-btn-sm" ><i class="fas fa-backward"></i>
                </a>
            @endauth
        </div>
    </div>
