<div class="modal-dialog" role="document">
	{!! Form::open(['url' => action([\Modules\Service\Http\Controllers\SellController::class, 'updateShipping'], [$transaction->id]), 'method' => 'put', 'id' => 'edit_shipping_form' ]) !!}
			...
			<div class="row">
		        ...
		        <div class="col-md-12">
		        	<div class="form-group">
					    ...
					    <input type="hidden" id="media_upload_url" value="{{route('service.attach.medias.to.model')}}">
