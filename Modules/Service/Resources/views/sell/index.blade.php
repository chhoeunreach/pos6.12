...
@section('content')
    ...
    <section class="content no-print">
        @component('service::components.filters', ['title' => __('report.filters')])
            ...
            @endif
        @endcomponent
        @component('service::components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_sales')])
            @can('direct_sell.access')
                @slot('tool')
                    <div class="box-tools">
                        <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right"
                            href="{{ action([\Modules\Service\Http\Controllers\SellController::class, 'create']) }}">
