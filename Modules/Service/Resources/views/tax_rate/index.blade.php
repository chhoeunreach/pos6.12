...
<section class="content">
    @component('service::components.widget', ['class' => 'box-primary', 'title' => __( 'tax_rate.all_your_tax_rates' )])
        @can('tax_rate.create')
            @slot('tool')
                <div class="box-tools">
                    <button class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full btn-modal pull-right"
                        data-href="{{action([\Modules\Service\Http\Controllers\TaxRateController::class, 'create'])}}" 
        ...
        @can('tax_rate.create')
            @slot('tool')
                <div class="box-tools">
                    ...
                    data-href="{{action([\Modules\Service\Http\Controllers\GroupTaxController::class, 'create'])}}" 
