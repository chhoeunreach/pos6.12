...
<section class="content no-print">
	...
	{!! Form::open(['url' => action([\Modules\Service\Http\Controllers\SellReturnController::class, 'store']), 'method' => 'post', 'id' => 'sell_return_form' ]) !!}
...
@section('javascript')
	<script src="{{ asset('js/sell_return.js?v=' . $asset_v . '-service-jsfix-20260609') }}"></script>
@endsection
