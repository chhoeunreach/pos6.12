                        ...
                        <tr>
                            ...
                            <td>
                              <a class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-accent"
                                   href="{{action([\Modules\Service\Http\Controllers\BackUpController::class, 'download'], [$backup['file_name']])}}"><i
                                ...
                                <a class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error link_confirmation" data-button-type="delete"
                                   href="{{ route('service.delete_backup', $backup['file_name']) }}"><i class="fa fa-trash-o"></i>
