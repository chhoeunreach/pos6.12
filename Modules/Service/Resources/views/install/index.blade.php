    ...
    <div class="row">
      <h3 class="text-center">{{ config('app.name', 'POS') }} Installation <small>Step 1 of 3</small></h3>
        ...
        <div class="col-md-8 col-md-offset-2">
          <hr/>
          @include('service::install.partials.nav', ['active' => 'install'])
          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              @include('service::install.partials.i_service')

              @include('service::install.partials.e_license')
              
              <a href="{{route('service.install.details')}}" class="btn btn-primary pull-right">I Agree, Let's Go!</a>
            </div>
          <!-- /.box-body -->
          </div>
