<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    {!! Form::open(['url' => action([\Modules\Service\Http\Controllers\CashRegisterController::class, 'postCloseRegister']), 'method' => 'post' ]) !!}
    ...
    <div class="modal-body">
      @if(auth()->user()->can('view_cash_register'))
        @include('service::cash_register.payment_details')
        <hr>
      @endif
      <div class="row">
      @if(auth()->user()->can('view_cash_register'))
