...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            @component('service::components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action([\Modules\Service\Http\Controllers\ReportController::class, 'getStockReport']), 'method' => 'get', 'id' => 'sales_representative_filter_form' ]) !!}
                <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-sm-12">
            @component('service::components.widget', ['title' => __('report.summary')])
                <h3 class="text-muted">
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="sr_sales_tab">
                        @include('service::report.partials.sales_representative_sales')
                    </div>

                    <div class="tab-pane" id="sr_commission_tab">
                        @include('service::report.partials.sales_representative_commission')
                    </div>

                    <div class="tab-pane" id="sr_expenses_tab">
                        @include('service::report.partials.sales_representative_expenses')
                    </div>

                    @if(!empty($pos_settings['cmmsn_calculation_type']) && $pos_settings['cmmsn_calculation_type'] == 'payment_received')
                        <div class="tab-pane" id="sr_payments_with_cmmsn_tab">
                            @include('service::report.partials.sales_representative_payments_with_cmmsn')
                        </div>
                    @endif
                </div>
...
@section('javascript')
    <script src="{{ asset('js/report.js?v=' . $asset_v . '-service-jsfix-20260609') }}"></script>
