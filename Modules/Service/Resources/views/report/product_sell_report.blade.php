    ...
    <div class="row">
        <div class="col-md-12">
            @component('service::components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action([\Modules\Service\Http\Controllers\ReportController::class, 'getStockReport']), 'method' => 'get', 'id' => 'product_sell_report_form' ]) !!}
                <div class="col-md-3">
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    @include('service::report.partials.product_sell_report_by_category')

                    @include('service::report.partials.product_sell_report_by_brand')
                </div>
            </div>
        </div>
    </div>
