...
<section class="content">
	{!! Form::open(['url' => action([\Modules\Service\Http\Controllers\ExpenseController::class, 'store']), 'method' => 'post', 'id' => 'add_expense_form', 'files' => true ]) !!}
			...
			<div class="row">
				...
				<div class="col-sm-4">
                    <div class="form-group">
                        ...
                        @includeIf('service::components.document_help_text')</p></small>
                    </div>
                </div>
				<div class="col-md-4">
			    	<div class="form-group">
	...
	@include('service::expense.recur_expense_form_part')
	@component('service::components.widget', ['class' => 'box-solid', 'id' => "payment_rows_div", 'title' => __('purchase.add_payment')])
	<div class="payment_row">
		@include('service::sale_pos.partials.payment_row_form', ['row_index' => 0, 'show_date' => true])
		<hr>
		<div class="row">
			<div class="col-sm-12">
