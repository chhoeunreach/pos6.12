...
<section class="content no-print">
	{!! Form::open(['url' => action([\Modules\Service\Http\Controllers\CombinedPurchaseReturnController::class, 'update']), 'method' => 'post', 'id' => 'purchase_return_form', 'files' => true ]) !!}
					...
					id="purchase_return_product_table">
						...
						<tbody>
							@foreach($purchase_lines as $purchase_line)
								@include('service::purchase_return.partials.product_table_row', ['product' => $purchase_line, 'row_index' => $loop->index, 'edit' => true])
...
@stop
@section('javascript')
	<script src="{{ asset('js/purchase_return.js?v=' . $asset_v . '-service-jsfix-20260609') }}"></script>
