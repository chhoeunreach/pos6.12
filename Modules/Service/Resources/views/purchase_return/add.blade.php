...
<section class="content">
	{!! Form::open(['url' => action([\Modules\Service\Http\Controllers\PurchaseReturnController::class, 'store']), 'method' => 'post', 'id' => 'purchase_return_form' ]) !!}
	{!! Form::hidden('transaction_id', $purchase->id); !!}

	@component('service::components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.parent_purchase')])
		<div class="row">
			<div class="col-sm-4">
