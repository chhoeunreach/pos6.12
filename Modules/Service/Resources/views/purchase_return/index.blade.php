...
@section('content')
    ...
    <section class="content no-print">
        ...
        @endcomponent
        @component('service::components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_purchase_returns')])
            @can('purchase.update')
                @slot('tool')
                    <div class="box-tools">
                        {{-- <a class="btn btn-block btn-primary" href="{{action([\Modules\Service\Http\Controllers\CombinedPurchaseReturnController::class, 'create'])}}">
                    <i class="fa fa-plus"></i> @lang('messages.add')</a> --}}
                        <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right"
                            href="{{action([\Modules\Service\Http\Controllers\CombinedPurchaseReturnController::class, 'create'])}}">
            ...
            @endcan
            @can('purchase.view')
                @include('service::purchase_return.partials.purchase_return_list')
            @endcan
        @endcomponent
