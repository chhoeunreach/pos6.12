...
<section class="content">
    @component('service::components.widget', ['class' => 'box-primary', 'title' => __( 'user.all_roles' )])
        @can('roles.create')
            @slot('tool')
                <div class="box-tools">
                    ...
                    href="{{ route('service.roles.create') }}">
...
<script type="text/javascript">
    ...
    $(document).ready( function(){
        var roles_table = $('#roles_table').DataTable({
                    ...
                    serverSide: true,
                    fixedHeader:false,
                    ajax: "{{ url(config('service.route_prefix', 'service-pos') . '/roles') }}",
                    buttons:[],
                    columnDefs: [ {
                        "targets": 1,
                        "orderable": false,
