...
{!! Form::open(['url' => action([\Modules\Service\Http\Controllers\InvoiceLayoutController::class, 'store']), 'method' => 'post', 'id' => 'add_invoice_layout_form', 'files' => true]) !!}
  ...
  @if(!empty($enabled_modules) && in_array('types_of_service', $enabled_modules) )
    @include('service::types_of_service.invoice_layout_settings')
  @endif
  
  <!-- Call restaurant module if defined -->
  @include('service::restaurant.partials.invoice_layout')
