...
{!! Form::open(['url' => action([\Modules\Service\Http\Controllers\InvoiceLayoutController::class, 'update'], [$invoice_layout->id]), 'method' => 'put', 
...
@component('service::components.widget', ['class' => 'box-solid', 'title' => __('lang_v1.qr_code')])
  <div class="row">
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
...
@if(!empty($enabled_modules) && in_array('types_of_service', $enabled_modules) )
    @include('service::types_of_service.invoice_layout_settings', ['module_info' => $invoice_layout->module_info])
@endif
<!-- Call restaurant module if defined -->
@include('service::restaurant.partials.invoice_layout', ['module_info' => $invoice_layout->module_info, 'edit_il' => true])
