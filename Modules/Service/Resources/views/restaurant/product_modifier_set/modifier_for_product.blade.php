...
<div>
  <span class="selected_modifiers">
    @if(!empty($edit_modifiers) && !empty($product->modifiers) )
      @include('service::restaurant.product_modifier_set.add_selected_modifiers', array('index' => $row_count, 'modifiers' => $product->modifiers ) )
    @endif
  </span>&nbsp;  
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-footer">
      <button data-url="{{action([\Modules\Service\Http\Controllers\Restaurant\ProductModifierSetController::class, 'add_selected_modifiers'])}}" type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white add_modifier" data-dismiss="modal">
