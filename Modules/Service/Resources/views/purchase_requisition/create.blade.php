...
<section class="content">
	{!! Form::open(['url' => action([\Modules\Service\Http\Controllers\PurchaseRequisitionController::class, 'store']), 'method' => 'post', 'id' => 'add_purchase_requisition_form' ]) !!}
	...
	<script type="text/javascript">
		$(document).ready( function(){
            ...
            $('#show_pr_products').click( function(){
            	...
            	$.ajax({
                    method: 'post',
                    url: "{{route('service.get-requisition-products')}}",
                    dataType: 'html',
                    data: data,
