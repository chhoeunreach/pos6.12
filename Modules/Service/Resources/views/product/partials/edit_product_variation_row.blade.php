                                ...
                                <div class="existing-images" style="margin-bottom: 5px;">
                                    @foreach($variation->media as $media)
                                        <div class="img-thumbnail" style="display: inline-block; position: relative; margin-right: 3px; margin-bottom: 3px;">
                                            <span class="badge bg-red delete-media" style="position: absolute; top: -5px; right: -5px; cursor: pointer;" data-href="{{ action([\Modules\Service\Http\Controllers\ProductController::class, 'deleteMedia'], ['media_id' => $media->id])}}"><i class="fas fa-times"></i></span>
                                            {!! $media->thumbnail() !!}
                                        </div>
                                    @endforeach
                                </div>
