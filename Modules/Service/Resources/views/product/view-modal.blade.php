	...
	<div class="modal-content">
	    ...
	    <div class="modal-body">
      		...
      		@if($product->type == 'single')
      			@include('service::product.partials.single_product_details')
      		@elseif($product->type == 'variable')
      			@include('service::product.partials.variable_product_details')
      		@elseif($product->type == 'combo')
      			@include('service::product.partials.combo_product_details')
      		@endif
