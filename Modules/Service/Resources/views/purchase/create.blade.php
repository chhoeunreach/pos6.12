...
<section class="content-header">
    <div class="tw-flex tw-justify-between tw-items-center">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black use_ai_btn">@lang('purchase.add_purchase') <i class="fa fa-keyboard hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('service::purchase.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h1>
    </div>
</section>
...
<section class="content">
	...
	@include('service::layouts.partials.error')

	{!! Form::open(['url' => action([\Modules\Service\Http\Controllers\PurchaseController::class, 'store']), 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]) !!}
	@component('service::components.widget', ['class' => 'box-primary'])
		<div class="row">
	...
	@component('service::components.widget', ['class' => 'box-primary'])
		<div class="row">
			...
			<div class="col-sm-2">
				<div class="form-group">
					<button tabindex="-1" type="button" class="btn btn-link btn-modal"data-href="{{action([\Modules\Service\Http\Controllers\ProductController::class, 'quickAdd'])}}" 
	...
	@endcomponent
	@component('service::components.widget', ['class' => 'box-primary', 'title' => __('purchase.add_payment')])
...
@include('service::purchase.partials.import_purchase_products_modal')
<!-- /.content -->
@endsection
...
@section('javascript')
	...
	@include('service::purchase.partials.keyboard_shortcuts')
@endsection
