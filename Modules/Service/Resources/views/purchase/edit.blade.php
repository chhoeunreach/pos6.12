...
<section class="content">
  ...
  {!! Form::open(['url' =>  action([\Modules\Service\Http\Controllers\PurchaseController::class, 'update'] , [$purchase->id] ), 'method' => 'PUT', 'id' => 'add_purchase_form', 'files' => true ]) !!}
  ...
  <input type="hidden" id="purchase_id" value="{{ $purchase->id }}">
    ...
    @component('service::components.widget', ['class' => 'box-primary'])
        ...
        <div class="row">
            <div class="col-sm-12">
              @include('service::purchase.partials.edit_purchase_entry_row')
