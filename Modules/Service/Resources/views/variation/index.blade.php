...
@section('content')
    ...
    <section class="content">
        @component('service::components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_variations')])
            @slot('tool')
                <div class="box-tools">
                    ...
                    data-href="{{action([\Modules\Service\Http\Controllers\VariationTemplateController::class, 'create'])}}" 
