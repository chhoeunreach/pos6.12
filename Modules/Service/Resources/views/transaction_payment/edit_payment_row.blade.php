<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action([\Modules\Service\Http\Controllers\TransactionPaymentController::class, 'update'], [$payment_line->id]), 'method' => 'put', 'id' => 'transaction_payment_add_form', 'files' => true ]) !!}
    ...
    <div class="modal-body">
      ...
      <div class="row payment_row">
        ...
        <div class="clearfix"></div>
          @include('service::transaction_payment.payment_type_details')
        <div class="col-md-12">
          <div class="form-group">
