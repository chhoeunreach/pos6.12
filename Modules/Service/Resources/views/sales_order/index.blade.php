...
<section class="content no-print">
    ...
    @component('service::components.widget', ['class' => 'box-primary'])
        @can('so.create')
            @slot('tool')
                <div class="box-tools">
                    <a class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-sm tw-text-white" href="{{action([\Modules\Service\Http\Controllers\SellController::class, 'create'])}}?sale_type=sales_order">
