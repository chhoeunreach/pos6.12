<div class="modal-dialog modal-xl" role="document">
	...
	{!! Form::open(['url' => action([\Modules\Service\Http\Controllers\OpeningStockController::class, 'save']), 'method' => 'post', 'id' => 'add_opening_stock_form' ]) !!}
	{!! Form::hidden('product_id', $product->id); !!}
	    ...
	    <div class="modal-body">
			@include('service::opening_stock.form-part')
		</div>
