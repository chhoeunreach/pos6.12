<div class="modal-dialog" role="document">
    {!! Form::open(['url' => action([\Modules\Service\Http\Controllers\PurchaseOrderController::class, 'postEditPurchaseOrderStatus'], ['id' => $id]), 'method' => 'put', 'id' => 'update_po_status_form']) !!}
