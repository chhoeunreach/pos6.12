...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.edit_purchase_order') <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('service::purchase.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h1>
</section>
...
<section class="content">
  ...
  {!! Form::open(['url' =>  action([\Modules\Service\Http\Controllers\PurchaseOrderController::class, 'update'] , [$purchase->id] ), 'method' => 'PUT', 'id' => 'add_purchase_form', 'files' => true ]) !!}
  ...
  <input type="hidden" id="purchase_id" value="{{ $purchase->id }}">
    ...
    @component('service::components.widget', ['class' => 'box-primary'])
        ...
        <div class="row">
            <div class="col-sm-12">
              @include('service::purchase.partials.edit_purchase_entry_row', ['is_purchase_order' => true])
