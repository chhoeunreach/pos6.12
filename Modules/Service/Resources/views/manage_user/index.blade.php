...
<section class="content">
    @component('service::components.widget', ['class' => 'box-primary', 'title' => __( 'user.all_users' )])
        @can('user.create')
            @slot('tool')
                <div class="box-tools">
                    <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full" href="{{action([\Modules\Service\Http\Controllers\ManageUserController::class, 'create'])}}">
...
<script type="text/javascript">
    ...
    $(document).ready( function(){
        var users_table = $('#users_table').DataTable({
                    ...
                    serverSide: true,
                    fixedHeader:false,
                    ajax: '{{ route('service.users.index') }}',
                    columnDefs: [ {
                        "targets": [4],
                        "orderable": false,
                        "searchable": false
