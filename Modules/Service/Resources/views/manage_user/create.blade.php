...
{!! Form::open(['url' => action([\Modules\Service\Http\Controllers\ManageUserController::class, 'store']), 'method' => 'post', 'id' => 'user_add_form' ]) !!}
  <div class="row">
    <div class="col-md-12">
  ...
  <div class="col-md-12">
    ...
    @include('service::user.edit_profile_form_part')
