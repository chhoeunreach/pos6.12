        ...
        <div class="col-md-4">
            <div
                ...
                <div class="tw-flex tw-flex-col tw-gap-4 tw-dw-rounded-box tw-dw-p-6 tw-dw-max-w-md">
                    ...
                    <form method="POST" action="{{ route('service.login') }}" id="login-form">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group has-feedback {{ $errors->has('password') ? ' has-error' : '' }}">
                            <label class="tw-dw-form-control">
                                <div class="tw-dw-label">
                                    ...
                                    @if (config('app.env') != 'demo')
                                        <a href="{{ route('service.password.request') }}"
                                ...
                                <button type="button" id="show_hide_icon" class="show_hide_icon"
                                    style="position: absolute; top:48px;right:5px; width:24px; height:24px; padding:0; border:0; background:transparent; line-height:1;">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye tw-w-6" width="24" height="24" style="width:24px;height:24px;display:block;" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="tw-flex tw-items-center tw-flex-col">
                        ...
                        @if (!($request->segment(1) == 'business' && $request->segment(2) == 'register'))
                            ...
                            @if (config('constants.allow_registration'))
                                <a href="{{ route('service.business.getRegister') }}@if (!empty(request()->lang)) {{ '?lang=' . request()->lang }} @endif"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.change_lang').click(function() {
                window.location = "{{ route('service.login') }}?lang=" + $(this).attr('value');
            });
