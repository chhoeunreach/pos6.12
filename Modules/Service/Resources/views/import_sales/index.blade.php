...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            @component('service::components.widget')
                {!! Form::open(['url' => action([\Modules\Service\Http\Controllers\ImportSalesController::class, 'preview']), 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
                    <div class="row">
                        <div class="col-sm-6">
                        <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <br>
                            <a href="{{ asset('modules/service/v7/files/import_sales_template.xlsx') }}" class="tw-dw-btn tw-dw-btn-success tw-text-white" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            @component('service::components.widget', ['title' => __('lang_v1.instructions')])
    ...
    <div class="row">
        <div class="col-md-12">
            @component('service::components.widget', ['title' => __('lang_v1.imports')])
                ...
                <tbody>
                    @foreach($imported_sales_array as $key => $value)
                        <tr>
                            ...
                            @can('sell.delete')
                                <td><a href="{{action([\Modules\Service\Http\Controllers\ImportSalesController::class, 'revertSaleImport'], $key)}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error revert_import"><i class="fas fa-undo"></i> @lang('lang_v1.revert_import')</a></td>
                            @endcan
                        </tr>
                    @endforeach
                </tbody>
