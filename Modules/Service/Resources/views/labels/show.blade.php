...
<section class="content no-print">
	...
	@component('service::components.widget', ['class' => 'box-primary', 'title' => __('product.add_product_for_labels')])
		<div class="row">
		...
		<div class="row">
			<div class="col-sm-10 col-sm-offset-2">
				<table class="table table-bordered table-striped table-condensed" id="product_table">
					...
					<tbody>
						@include('service::labels.partials.show_table_rows', ['index' => 0])
					</tbody>
				</table>
			</div>
		</div>
	...
	@component('service::components.widget', ['class' => 'box-primary', 'title' => __( 'barcode.info_in_labels' )])
		<div class="row">
			<div class="col-md-12">
...
@stop
@section('javascript')
	<script src="{{ asset('js/labels.js?v=' . $asset_v . '-service-jsfix-20260609') }}"></script>
@endsection
