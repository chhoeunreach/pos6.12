                ...
                <div class="tw-flex tw-gap-2.5 tw-justify-end">
                    @can('brand.create')
                            <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full btn-modal pull-right"
                                data-href="{{ action([\Modules\Service\Http\Controllers\DiscountController::class, 'create']) }}"
                                        ...
                                        <tr>
                                            <td colspan="11">
                                                <div style="display: flex; width: 100%;">
                                                    {!! Form::open([
                                                        'url' => action([\Modules\Service\Http\Controllers\DiscountController::class, 'massDeactivate']),
                                                        'method' => 'post',
