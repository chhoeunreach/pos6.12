...
@section('content')
    ...
    <div class="col-md-8 col-xs-12 col-md-offset-2 tw-mt-6">
        <div
            ...
            {!! Form::open([
                'url' => route('service.business.postRegister'),
                'method' => 'post',
                'id' => 'business_register_form',
                'files' => true,
            ]) !!}
            @include('service::business.partials.register_form', ['is_register' => true])
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.change_lang').click(function() {
                window.location = "{{ route('service.business.getRegister') }}?lang=" + $(this).attr('value');
            });
        })
    </script>
@endsection
