...
@if (!empty($api_key))
    @section('css')
        @include('service::contact.partials.google_map_styles')
    @endsection
@endif
@section('content')
        ...
        @component('service::components.widget', [
                ...
                @slot('tool')
                    <div class="box-tools">
                        <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full btn-modal"
                                data-href="{{ action([\Modules\Service\Http\Controllers\ContactController::class, 'create'], ['type' => $type]) }}"
            ...
            @if (auth()->user()->can('supplier.view') ||
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="contact_table" data-href="{{ action([\Modules\Service\Http\Controllers\ContactController::class, 'index']) }}">
                        <thead>
                            <tr>
