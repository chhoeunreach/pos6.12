...
use Modules\Service\Http\Controllers\AccountController;
use Modules\Service\Http\Controllers\AccountReportsController;
use Modules\Service\Http\Controllers\AccountTypeController;
// use Modules\Service\Http\Controllers\Auth;
use Modules\Service\Http\Controllers\BackUpController;
use Modules\Service\Http\Controllers\BarcodeController;
use Modules\Service\Http\Controllers\BrandController;
use Modules\Service\Http\Controllers\BusinessController;
use Modules\Service\Http\Controllers\BusinessLocationController;
use Modules\Service\Http\Controllers\CashRegisterController;
use Modules\Service\Http\Controllers\CategoryController;
use Modules\Service\Http\Controllers\CombinedPurchaseReturnController;
use Modules\Service\Http\Controllers\ContactController;
use Modules\Service\Http\Controllers\CustomerGroupController;
use Modules\Service\Http\Controllers\DashboardConfiguratorController;
use Modules\Service\Http\Controllers\DiscountController;
use Modules\Service\Http\Controllers\DocumentAndNoteController;
use Modules\Service\Http\Controllers\ExpenseCategoryController;
use Modules\Service\Http\Controllers\ExpenseController;
use Modules\Service\Http\Controllers\GroupTaxController;
use Modules\Service\Http\Controllers\HomeController;
use Modules\Service\Http\Controllers\ImportOpeningStockController;
use Modules\Service\Http\Controllers\ImportProductsController;
use Modules\Service\Http\Controllers\ImportSalesController;
use Modules\Service\Http\Controllers\Install;
use Modules\Service\Http\Controllers\InstallController as ServiceInstallController;
use Modules\Service\Http\Controllers\InvoiceLayoutController;
use Modules\Service\Http\Controllers\InvoiceSchemeController;
use Modules\Service\Http\Controllers\LabelsController;
use Modules\Service\Http\Controllers\LedgerDiscountController;
use Modules\Service\Http\Controllers\LocationSettingsController;
use Modules\Service\Http\Controllers\ManageUserController;
use Modules\Service\Http\Controllers\NotificationController;
use Modules\Service\Http\Controllers\NotificationTemplateController;
use Modules\Service\Http\Controllers\OpeningStockController;
use Modules\Service\Http\Controllers\PrinterController;
use Modules\Service\Http\Controllers\ProductController;
use Modules\Service\Http\Controllers\PurchaseController;
use Modules\Service\Http\Controllers\PurchaseOrderController;
use Modules\Service\Http\Controllers\PurchaseRequisitionController;
use Modules\Service\Http\Controllers\PurchaseReturnController;
use Modules\Service\Http\Controllers\ReportController;
use Modules\Service\Http\Controllers\Restaurant;
use Modules\Service\Http\Controllers\RoleController;
use Modules\Service\Http\Controllers\SalesCommissionAgentController;
use Modules\Service\Http\Controllers\SalesOrderController;
use Modules\Service\Http\Controllers\SellController;
use Modules\Service\Http\Controllers\SellingPriceGroupController;
use Modules\Service\Http\Controllers\SellPosController;
use Modules\Service\Http\Controllers\SellReturnController;
use Modules\Service\Http\Controllers\StockAdjustmentController;
use Modules\Service\Http\Controllers\StockTransferController;
use Modules\Service\Http\Controllers\TaxonomyController;
use Modules\Service\Http\Controllers\TaxRateController;
use Modules\Service\Http\Controllers\TransactionPaymentController;
use Modules\Service\Http\Controllers\TypesOfServiceController;
use Modules\Service\Http\Controllers\UnitController;
use Modules\Service\Http\Controllers\UserController;
use Modules\Service\Http\Controllers\VariationTemplateController;
use Modules\Service\Http\Controllers\WarrantyController;
...
Route::get('/install', [ServiceInstallController::class, 'index']);
Route::post('/install', [ServiceInstallController::class, 'install']);
...
Route::middleware(['setData', 'auth', 'service.database', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/pos/variations/bulk', [ProductController::class, 'getVariationDetailsBulk']);
    ...
    //Expense Categories...
    Route::get('expense-categories/download-template', [ExpenseCategoryController::class, 'downloadTemplate']);
    ...
    Route::get('manage-modules/{module_name}/install', [Install\ModulesController::class, 'installModule']);
    Route::get('manage-modules/{module_name}/uninstall', [Install\ModulesController::class, 'uninstallModule']);
    Route::get('manage-modules/{module_name}/update', [Install\ModulesController::class, 'updateModule']);
...
//common route
Route::middleware(['auth', 'service.database'])->group(function () {
    Route::get('/logout', [Modules\Service\Http\Controllers\Auth\LoginController::class, 'logout'])->name('logout');
});

Route::middleware(['setData', 'auth', 'service.database', 'language', 'timezone'])->group(function () {
