...
// on click sub category in category drawer
    ...
    function get_hr_sell_list(silent) {
        ...
        var sellType = $box.find('.sell-list-filter-sell-type').val() || '';
        ...
        $.ajax({
            method: 'GET',
            url: window.service_pos_base_url + '/sells/pos/get-hr-sell-list/' + location_id,
            dataType: 'json',
            data: {
                date_from: dateFrom,
                date_to: dateTo,
    ...
    $(document).on('click', '.sell-type-edit-btn', function(){
        ...
        $.ajax({
            method: 'GET',
            url: service_pos_url('/sells/pos/hr-sell-list-service-types/') + $('#location_id').val(),
            dataType: 'json',
    ...
    $(document).on('change', '.sell-type-edit-select', function(){
        ...
        $.ajax({
            method: 'POST',
            url: service_pos_url('/sells/pos/hr-sell-list-update-service-type'),
            data: {
                report_id: reportId,
    ...
    $(document).on('click', '.sell-list-copy-all-btn', function(){
        ...
        function process_next(index) {
            ...
            $.getJSON(service_pos_url('/sells/pos/resolve-hr-line-product'), {
                line_id: line.lineId,
    ...
    $(document).on('click', '.sell-list-add-all-btn', function(){
        ...
        function add_next(index) {
            ...
            $.ajax({
                method: 'POST',
                url: service_pos_url('/sells/pos/add-hr-sell-list-line'),
                dataType: 'json',
                data: {
                    line_id: lineId,
    ...
    $(document).on('click', '.sell-list-detail-btn', function(){
        ...
        $.ajax({
            method: 'GET',
            url: service_pos_url('/sells/pos/hr-sell-list-detail/') + reportId,
            dataType: 'html',
...
function init_pos_add_below_search($input, $anchor_row) {
    ...
    $input.autocomplete({
        source: function(request, response) {
            $.getJSON(service_pos_url('/products/list'),
                {
