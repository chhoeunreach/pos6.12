...
class ServiceBootstrapSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $serviceLocations = [
            ...
            ['id' => 7, 'location_id' => 'BL0065', 'name' => 'កាប់គោ-ជួសជុល', 'sell_type' => 'ជួសជុល'],
            ['id' => 8, 'location_id' => 'BL0066', 'name' => 'កាប់គោ-អ៊ុត', 'sell_type' => 'អ៊ុត'],
            ['id' => 9, 'location_id' => 'BL0067', 'name' => 'អ៊ីអន-ជួសជុល', 'sell_type' => 'ជួសជុល'],
            ['id' => 10, 'location_id' => 'BL0068', 'name' => 'អ៊ីអន-ការហ្វេរ', 'sell_type' => 'ការហ្វេរ'],
