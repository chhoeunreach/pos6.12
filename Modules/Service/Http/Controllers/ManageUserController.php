...
class ManageUserController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($users)
                ...
                ->addColumn(
                    'action',
                    '@can("user.update")
                        <a href="{{action(\'Modules\Service\Http\Controllers\ManageUserController@edit\', [$id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</a>
                        &nbsp;
                    @endcan
                    @can("user.view")
                    <a href="{{action(\'Modules\Service\Http\Controllers\ManageUserController@show\', [$id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-info"><i class="fa fa-eye"></i> @lang("messages.view")</a>
                    &nbsp;
                    @endcan
                    @can("user.delete")
                        <button data-href="{{action(\'Modules\Service\Http\Controllers\ManageUserController@destroy\', [$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_user_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                    @endcan'
                )
        ...
        return view('service::manage_user.index');
    }
    ...
    public function create()
    {
        ...
        if (! $this->moduleUtil->isSubscribed($business_id)) {
            ...
            return $this->moduleUtil->quotaExpiredResponse('users', $business_id, action([\Modules\Service\Http\Controllers\ManageUserController::class, 'index']));
        }
        ...
        $form_partials = $this->getServiceModuleData($this->moduleUtil, 'moduleViewPartials', ['view' => 'manage_user.create']);

        return view('service::manage_user.create')
    ...
    public function show($id)
    {
        ...
        $view_partials = $this->getServiceModuleData($this->moduleUtil, 'moduleViewPartials', ['view' => 'manage_user.show', 'user' => $user]);
        ...
        return view('service::manage_user.show')->with(compact('user', 'view_partials', 'users', 'activities'));
    }
    ...
    public function edit($id)
    {
        ...
        //Get user form part from modules
        $form_partials = $this->getServiceModuleData($this->moduleUtil, 'moduleViewPartials', ['view' => 'manage_user.edit', 'user' => $user]);

        return view('service::manage_user.edit')
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $this->getServiceModuleData($this->moduleUtil, 'afterModelSaved', ['event' => 'user_saved', 'model_instance' => $user]);
