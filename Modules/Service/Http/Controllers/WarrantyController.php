...
class WarrantyController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($warranties)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'Modules\Service\Http\Controllers\WarrantyController@edit\', [$id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary btn-modal" data-container=".view_modal"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>'
                 )
                 ->removeColumn('id')
        ...
        return view('service::warranties.index');
    }
    ...
    {
        return view('service::warranties.create');
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('service::warranties.edit')
