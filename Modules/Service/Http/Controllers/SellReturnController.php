...
class SellReturnController extends Controller
{
    ...
    public function index()
    {
                ...
                ->setRowAttr([
                    'data-href' => function ($row) {
                        if (auth()->user()->can('sell.view')) {
                            return action([\Modules\Service\Http\Controllers\SellReturnController::class, 'show'], [$row->parent_sale_id]);
                        } else {
                            return '';
                        }
                    }])
        ...
        return view('service::sell_return.index')->with(compact('business_locations', 'customers', 'sales_representative'));
    }
    ...
    //         return $this->moduleUtil->expiredResponse(action([\Modules\Service\Http\Controllers\SellReturnController::class, 'index']));
    //     }

    //     $business_locations = BusinessLocation::forDropdown($business_id);
    //     //$walk_in_customer = $this->contactUtil->getWalkInCustomer($business_id);

    //     return view('service::sell_return.create')
    ...
    public function add($id)
    {
        ...
        return view('service::sell_return.add')
            ->with(compact('sell'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (!empty($input['products'])) {
                ...
                $this->getServiceModuleData($this->moduleUtil, 'after_sales_return', ['transaction' => $sell_return]);
    ...
    public function show($id)
    {
        ...
        return view('service::sell_return.show')
    ...
    private function receiptContent(
        ...
        if ($location_details->print_receipt_on_invoice == 1) {
            ...
            if ($receipt_printer_type == 'printer') {
                ...
                $output['html_content'] = view('service::sell_return.receipt', compact('receipt_details'))->render();
            }
        }
    ...
    public function validateInvoiceToReturn($invoice_no)
    {
        ...
        return ['success' => 1,
            'redirect_url' => action([\Modules\Service\Http\Controllers\SellReturnController::class, 'add'], [$sell->id]),
        ];
    }
}
