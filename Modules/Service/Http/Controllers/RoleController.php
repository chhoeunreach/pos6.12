...
class RoleController extends Controller
{
    ...
    public function index()
    {
                ...
                ->addColumn('action', function ($row) {
                    if (! $row->is_default || $row->name == 'Cashier#'.$row->business_id) {
                        ...
                        if (auth()->user()->can('roles.update')) {
                            $action .= '<a href="'.route('service.roles.edit', [$row->id]).'" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary"><i class="glyphicon glyphicon-edit"></i> '.__('messages.edit').'</a>';
                        }
                        if (auth()->user()->can('roles.delete')) {
                            $action .= '&nbsp
                                <button data-href="'.route('service.roles.destroy', [$row->id]).'" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_role_button"><i class="glyphicon glyphicon-trash"></i> '.__('messages.delete').'</button>';
                        }
        ...
        return view('service::role.index');
    }
    ...
    public function create()
    {
        ...
        $module_permissions = $this->getServiceModuleData($this->moduleUtil, 'user_permissions');

        $common_settings = ! empty(session('business.common_settings')) ? session('business.common_settings') : [];

        return view('service::role.create')
