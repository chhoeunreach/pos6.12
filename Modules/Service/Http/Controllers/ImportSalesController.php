...
class ImportSalesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('service::import_sales.index')->with(compact('imported_sales_array', 'import_fields'));
    }
    ...
    public function preview(Request $request)
    {
        ...
        if ($request->hasFile('sales')) {
            ...
            return view('service::import_sales.preview')->with(compact('parsed_array', 'import_fields', 'file_name', 'business_locations', 'match_array'));
        }
    }
