...
class InstallController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('service::install.index');
    }
    ...
    public function checkServer()
    {
        ...
        return view('service::install.check-server')
            ->with(compact('output'));
    }
    ...
    public function details()
    {
        ...
        return view('service::install.details')
    ...
    public function postDetails(Request $request)
    {
        ...
        try {
            ...
            if (false) {
                ...
                // return redirect()->route('service.install.success');
            } else {
                $this->deleteEnv();
                ...
                return view('service::install.envText')
    ...
    public function installAlternate(Request $request)
    {
        try {
            ...
            $envPath = base_path('.env');
            if (! file_exists($envPath)) {
                return redirect()->route('service.install.details')
    ...
    {
        return view('service::install.success');
    }
    ...
    public function updateConfirmation()
    {
        ...
        if (Comparator::greaterThan($this->appVersion, $db_version)) {
            return view('service::install.update_confirmation');
        } else {
            // abort(404);
