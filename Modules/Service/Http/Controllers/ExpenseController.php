...
class ExpenseController extends Controller
{
    ...
    public function index()
    {
            ...
            return Datatables::of($expenses)
                ->addColumn(
                    ...
                    @if(auth()->user()->can("expense.edit"))
                        <li><a href="{{action(\'Modules\Service\Http\Controllers\ExpenseController@edit\', [$id])}}"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</a></li>
                    @endif
                    @if($document)
                    ...
                    @if(auth()->user()->can("expense.delete"))
                        <li>
                        <a href="#" data-href="{{action(\'Modules\Service\Http\Controllers\ExpenseController@destroy\', [$id])}}" class="delete_expense"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</a></li>
                    @endif
                    <li class="divider"></li> 
                    @if($payment_status != "paid")
                        <li><a href="{{action([\Modules\Service\Http\Controllers\TransactionPaymentController::class, \'addPayment\'], [$id])}}" class="add_payment_modal"><i class="fas fa-money-bill-alt" aria-hidden="true"></i> @lang("purchase.add_payment")</a></li>
                    @endif
                    <li><a href="{{action([\Modules\Service\Http\Controllers\TransactionPaymentController::class, \'show\'], [$id])}}" class="view_payment_modal"><i class="fas fa-money-bill-alt" aria-hidden="true" ></i> @lang("purchase.view_payments")</a></li>
                    </ul></div>'
                )
                ->removeColumn('id')
                ->editColumn(
                ...
                ->editColumn(
                    'payment_status',
                    '<a href="{{ action([\Modules\Service\Http\Controllers\TransactionPaymentController::class, \'show\'], [$id])}}" class="view_payment_modal payment-status" data-orig-value="{{$payment_status}}" data-status-name="{{__(\'lang_v1.\' . $payment_status)}}"><span class="label @payment_status($payment_status)">{{__(\'lang_v1.\' . $payment_status)}}
                        </span></a>'
                )
        ...
        return view('service::expense.index')
    ...
    public function create()
    {
        ...
        if (! $this->moduleUtil->isSubscribed($business_id)) {
            return $this->moduleUtil->expiredResponse(action([\Modules\Service\Http\Controllers\ExpenseController::class, 'index']));
        }
        ...
        if (request()->ajax()) {
            return view('service::expense.add_expense_modal')
        ...
        return view('service::expense.create')
            ->with(compact('expense_categories', 'business_locations', 'users', 'taxes', 'payment_line', 'payment_types', 'accounts', 'bl_attributes', 'contacts'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('service::expense.edit')
    ...
    public function importExpense()
    {
        ...
        if ($zip_loaded === false) {
            ...
            return view('service::expense.import', compact('payment_types'))
