...
class ImportProductsController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($zip_loaded === false) {
            ...
            return view('service::import_products.index')
    ...
    public function downloadImportTemplate()
    {
        ...
        return Excel::download(new ImportProductsTemplateExport, 'service_import_products_template.xlsx');
    }
        ...
        try {
            ...
            if ($request->hasFile('products_csv')) {
                ...
                if (! $this->moduleUtil->isSubscribed($business_id)) {
                    ...
                    return $this->moduleUtil->quotaExpiredResponse('products', $business_id, action([\Modules\Service\Http\Controllers\ImportProductsController::class, 'index']));
                }
