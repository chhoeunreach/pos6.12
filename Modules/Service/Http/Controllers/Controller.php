...
class Controller extends BaseController
{
    ...
    protected function getServiceModuleData($moduleUtil, string $functionName, $arguments = null): array
    {
        $moduleNames = $this->getServiceAllowedModuleNames();

        return $moduleUtil->getModuleData($functionName, $arguments, $moduleNames);
    }

    protected function isServiceModuleInstalled($moduleUtil, string $moduleName): bool
    {
        if (in_array(strtolower($moduleName), $this->getServiceExcludedModuleNames(), true)) {
            return false;
        }
    ...
    private function getServiceAllowedModuleNames(): array
    {
        $excludedModules = $this->getServiceExcludedModuleNames();
    ...
    private function getServiceExcludedModuleNames(): array
    {
        return array_map('strtolower', config('service.excluded_main_modules', []));
    }
