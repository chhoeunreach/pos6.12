...
class NotificationTemplateController extends Controller
{
    ...
    public function index()
    {
        ...
        $module_customer_notifications = $this->getServiceModuleData($this->moduleUtil, 'notification_list', ['notification_for' => 'customer']);
        ...
        $module_supplier_notifications = $this->getServiceModuleData($this->moduleUtil, 'notification_list', ['notification_for' => 'supplier']);
        ...
        return view('service::notification_template.index')
