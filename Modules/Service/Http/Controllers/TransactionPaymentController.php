...
class TransactionPaymentController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('service::transaction_payment.show_payments')
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('service::transaction_payment.edit_payment_row')
    ...
    public function addPayment($transaction_id)
    {
        ...
        if (request()->ajax()) {
            ...
            if ($transaction->payment_status != 'paid') {
                ...
                $view = view('service::transaction_payment.payment_row')
    ...
    public function getPayContactDue($contact_id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('service::transaction_payment.pay_supplier_due_modal')
    ...
    public function viewPayment($payment_id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('service::transaction_payment.single_payment_view')
    ...
    public function showChildPayments($payment_id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('service::transaction_payment.show_child_payments')
    ...
    public function getOpeningBalancePayments($contact_id)
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($query)
                ...
                ->addColumn('action', '<button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-primary view_payment" data-href="{{ action([\Modules\Service\Http\Controllers\TransactionPaymentController::class, \'viewPayment\'], [$id]) }}"><i class="fas fa-eye"></i> @lang("messages.view")
                    </button> <button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-info edit_payment" 
                    data-href="{{action([\Modules\Service\Http\Controllers\TransactionPaymentController::class, \'edit\'], [$id]) }}"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                    &nbsp; <button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-error delete_payment" 
                    data-href="{{ action([\Modules\Service\Http\Controllers\TransactionPaymentController::class, \'destroy\'], [$id]) }}"
