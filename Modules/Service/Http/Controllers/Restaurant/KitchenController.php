...
class KitchenController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('service::restaurant.kitchen.index', compact('orders'));
    }
    ...
    public function refreshOrdersList(Request $request)
    {
        ...
        return view('service::restaurant.partials.show_orders', compact('orders', 'orders_for'));
    }
    ...
    public function refreshLineOrdersList(Request $request)
    {
        ...
        return view('service::restaurant.partials.line_orders', compact('line_orders', 'orders_for'));
    }
}
