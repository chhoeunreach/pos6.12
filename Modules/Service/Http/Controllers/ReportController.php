...
class ReportController extends Controller
{
    ...
    public function getProfitLoss(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return view('service::report.partials.profit_loss_details', compact('data'))->render();
        }

        $business_locations = BusinessLocation::forDropdown($business_id, true);

        return view('service::report.profit_loss', compact('business_locations'));
    }
    ...
    public function getPurchaseSell(Request $request)
    {
        ...
        return view('service::report.purchase_sell')
    ...
    public function getCustomerSuppliers(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($contacts)
                ->editColumn('name', function ($row) {
                    ...
                    return '<a href="'.action([\Modules\Service\Http\Controllers\ContactController::class, 'show'], [$row->id]).'" target="_blank" class="no-print">'.
                            $name.
                        '</a>';
                })
                ->editColumn(
        ...
        return view('service::report.contact')
    ...
    public function getStockReport(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if ($for == 'view_product' && ! empty(request()->input('product_id'))) {
                ...
                return view('service::product.partials.product_stock_details')->with(compact('product_stock_details'));
            }
            ...
            $datatable = Datatables::of($products)
                ...
                ->addColumn('action', function ($row) {
                    return '<a class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-info tw-w-max " href="'.action([\Modules\Service\Http\Controllers\ProductController::class, 'productStockHistory'], [$row->product_id]).
                ...
                ->editColumn('unit_price', function ($row) use ($allowed_selling_price_group) {
                    ...
                    if ($allowed_selling_price_group) {
                        $html .= ' <button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-primary tw-w-max btn-modal no-print" data-container=".view_modal" data-href="'.action([\Modules\Service\Http\Controllers\ProductController::class, 'viewGroupPrice'], [$row->product_id]).'">'.__('lang_v1.view_group_prices').'</button>';
                    }
        ...
        return view('service::report.stock_report')
    ...
    //             })
    //             ->addColumn('action', function ($row) {
    //                 return '<a class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-info" href="'.action([\Modules\Service\Http\Controllers\ProductController::class, 'productStockHistory'], [$row->product_id]).
    //                 '?location_id='.$row->location_id.'&variation_id='.$row->variation_id.
    //                 '"><i class="fas fa-history"></i> '.__('lang_v1.product_stock_history').'</a>';
    //             })
    //             ->addColumn('variation', function ($row) {
    ...
    //                 if ($allowed_selling_price_group) {
    //                     $html .= ' <button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-primary btn-modal no-print" data-container=".view_modal" data-href="'.action([\Modules\Service\Http\Controllers\ProductController::class, 'viewGroupPrice'], [$row->product_id]).'">'.__('lang_v1.view_group_prices').'</button>';
    //                 }
    ...
    public function getStockDetails(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return view('service::report.stock_details')
    ...
    public function getTaxReport(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $module_output_taxes = $this->getServiceModuleData($this->moduleUtil, 'getModuleOutputTax', ['start_date' => $start_date, 'end_date' => $end_date]);
        ...
        $tax_report_tabs = $this->getServiceModuleData($this->moduleUtil, 'getTaxReportViewTabs');

        $contact_dropdown = Contact::contactDropdown($business_id, false, false);

        return view('service::report.tax_report')
    ...
    public function getTrendingProducts(Request $request)
    {
        ...
        return view('service::report.trending_products')
    ...
    public function getExpenseReport(Request $request)
    {
        ...
        return view('service::report.expense_report')
    ...
    public function getStockAdjustmentReport(Request $request)
    {
        ...
        return view('service::report.stock_adjustment_report')
                    ->with(compact('business_locations'));
    }
    ...
    public function getRegisterReport(Request $request)
    {
        ...
        $permitted_locations = auth()->user()->permitted_locations();
            ...
            return Datatables::of($registers)
                ...
                ->addColumn('action', '@if(auth()->user()->can("view_cash_register"))<button type="button" data-href="{{action(\'Modules\Service\Http\Controllers\CashRegisterController@show\', [$id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-info tw-w-max btn-modal" 
                    data-container=".view_register"><i class="fas fa-eye" aria-hidden="true"></i> @lang("messages.view")</button>@endif @if($status != "close" && auth()->user()->can("close_cash_register"))<button type="button" data-href="{{action(\'Modules\Service\Http\Controllers\CashRegisterController@getCloseRegister\', [$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error tw-w-max btn-modal" 
        ...
        return view('service::report.register_report')
    ...
    public function getSalesRepresentativeReport(Request $request)
    {
        ...
        return view('service::report.sales_representative')
    ...
    public function getStockExpiryReport(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($report)
                ...
                ->editColumn('ref_no', function ($row) {
                    return '<button type="button" data-href="'.action([\Modules\Service\Http\Controllers\PurchaseController::class, 'show'], [$row->transaction_id])
                ...
                ->addColumn('edit', function ($row) {
                    ...
                    if (! empty($row->exp_date)) {
                        ...
                        $carbon_now = \Carbon::now();
                        if ($carbon_now->diffInDays($carbon_exp, false) < 0) {
                            $html .= ' <button type="button" class="btn btn-warning btn-xs remove_from_stock_btn" data-href="'.action([\Modules\Service\Http\Controllers\StockAdjustmentController::class, 'removeExpiredStock'], [$row->purchase_line_id]).'"> <i class="fa fa-trash"></i> '.__('lang_v1.remove_from_stock').
                            '</button>';
                        }
                    }
        ...
        return view('service::report.stock_expiry_report')
    ...
    public function getStockExpiryReportEditModal(Request $request, $purchase_line_id)
    {
        ...
        if ($request->ajax()) {
            ...
            return view('service::report.partials.stock_expiry_edit_modal')
    ...
    public function getCustomerGroup(Request $request)
    {
        ...
        return view('service::report.customer_group')
    ...
    public function getproductPurchaseReport(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($query)
                ->editColumn('product_name', function ($row) {
                 ...
                 ->editColumn('ref_no', function ($row) {
                     return '<a data-href="'.action([\Modules\Service\Http\Controllers\PurchaseController::class, 'show'], [$row->transaction_id])
        ...
        return view('service::report.product_purchase_report')
    ...
    public function getproductSellReport(Request $request)
    {
            ...
            return Datatables::of($query)
                ->editColumn('product_name', function ($row) {
                 ...
                 ->editColumn('invoice_no', function ($row) {
                     return '<a data-href="'.action([\Modules\Service\Http\Controllers\SellController::class, 'show'], [$row->transaction_id])
        ...
        return view('service::report.product_sell_report')
    ...
    public function getLotReport(Request $request)
    {
        ...
        return view('service::report.lot_report')
    ...
    public function purchasePaymentReport(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($query)
                ...
                ->addColumn('action', '<button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-primary view_payment" data-href="{{ action([\Modules\Service\Http\Controllers\TransactionPaymentController::class, \'viewPayment\'], [$DT_RowId]) }}">@lang("messages.view")
        ...
        return view('service::report.purchase_payment_report')
    ...
    public function sellPaymentReport(Request $request)
    {
        ...
        return view('service::report.sell_payment_report')
    ...
    public function getTableReport(Request $request)
    {
        ...
        return view('service::report.table_report')
            ->with(compact('business_locations'));
    }
    ...
    public function getServiceStaffReport(Request $request)
    {
        ...
        return view('service::report.service_staff_report')
    ...
    public function productStockDetails()
    {
        ...
        return view('service::report.product_stock_details')
    ...
    public function getProfit($by = null)
    {
        ...
        if ($by == 'day') {
            ...
            return view('service::report.partials.profit_by_day')->with(compact('profits', 'days'));
        }
    ...
    public function itemsReport()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($query)
                ...
                ->editColumn('purchase_ref_no', function ($row) {
                    $html = $row->purchase_type == 'purchase' ? '<a data-href="'.action([\Modules\Service\Http\Controllers\PurchaseController::class, 'show'], [$row->purchase_id])
        ...
        return view('service::report.items_report')->with(compact('suppliers', 'customers', 'business_locations'));
    }
    ...
    public function purchaseReport()
    {
                ...
                ->setRowAttr([
                    'data-href' => function ($row) {
                        if (auth()->user()->can('purchase.view')) {
                            return  action([\Modules\Service\Http\Controllers\PurchaseController::class, 'show'], [$row->id]);
                        } else {
                            return '';
                        }
                    }, ])
        ...
        return view('service::report.purchase_report')
    ...
    public function saleReport()
    {
        ...
        return view('service::report.sale_report')
    ...
    public function activityLog()
    {
            ...
            return Datatables::of($activities)
                            ...
                            ->addColumn('note', function ($row) use ($statuses, $shipping_statuses) {
                                ...
                                if ($row->subject_type == \App\Transaction::class && ! empty($row->subject) && in_array($row->subject->type, ['sell', 'purchase'])) {
                                    $html .= view('service::sale_pos.partials.activity_row', ['activity' => $row, 'statuses' => $statuses, 'shipping_statuses' => $shipping_statuses])->render();
                                } else {
        ...
        return view('service::report.activity_log')->with(compact('users', 'transaction_types'));
    }
    ...
    public function gstSalesReport(Request $request)
    {
        ...
        return view('service::report.gst_sales_report')->with(compact('customers', 'taxes'));
    }
    ...
    public function gstPurchaseReport(Request $request)
    {
        ...
        return view('service::report.gst_purchase_report')->with(compact('suppliers', 'taxes'));
    }
}
