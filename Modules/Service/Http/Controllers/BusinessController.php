...
class BusinessController extends Controller
{
    ...
    */
    ...
    public function getRegister()
    {
        ...
        return view('service::business.register', compact(
            'currencies',
            'timezone_list',
            'months',
            'accounting_methods',
    ...
    public function postRegister(Request $request)
    {
        ...
        try {
            ...
            if (config('app.env') != 'demo') {
                $this->getServiceModuleData($this->moduleUtil, 'after_business_created', ['business' => $business]);
            }
            ...
            if ($is_installed_superadmin && ! empty($package_id) && (config('app.env') != 'demo')) {
                ...
                if (! empty($package)) {
                    Auth::login($user);
                    return redirect()->route('service.register-pay', ['package_id' => $package_id]);
                }
            }
    ...
    public function postBusinessSettings(Request $request)
    {
        ...
        return redirect()->route('service.business.getBusinessSettings')->with('status', $output);
    }
    ...
    public function testEmailConfiguration(Request $request)
    {
        try {
            ...
            \Notification::route('service.mail', $email_settings['mail_from_address'])
