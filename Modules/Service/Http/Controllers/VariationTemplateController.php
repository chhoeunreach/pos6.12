...
class VariationTemplateController extends Controller
{
    ...
    public function index()
    {
        if (request()->ajax()) {
            ...
            return Datatables::of($variations)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'Modules\Service\Http\Controllers\VariationTemplateController@edit\', [$id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary edit_variation_button"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                        &nbsp;
                        @if(empty($total_pv))
                        <button data-href="{{action(\'Modules\Service\Http\Controllers\VariationTemplateController@destroy\', [$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_variation_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                        @endif'
                )
        ...
        return view('service::variation.index');
    }
    ...
    {
        return view('service::variation.create');
    }
    ...
    public function edit($id)
    {
        if (request()->ajax()) {
            ...
            return view('service::variation.edit')
