@if($__is_repair_enabled)
	@can("repair.create")
		...
		href="{{ repair_url('pos/create') }}?sub_type=repair" title="{{ __('repair::lang.add_repair') }}" data-toggle="tooltip" data-placement="bottom" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary m-6 btn-xs m-5 pull-right">
