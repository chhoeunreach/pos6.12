...
use Modules\Accessory\Http\Controllers\AccountController;
use Modules\Accessory\Http\Controllers\AccountReportsController;
use Modules\Accessory\Http\Controllers\AccountTypeController;
// use Modules\Accessory\Http\Controllers\Auth;
use Modules\Accessory\Http\Controllers\BackUpController;
use Modules\Accessory\Http\Controllers\BarcodeController;
use Modules\Accessory\Http\Controllers\BrandController;
use Modules\Accessory\Http\Controllers\BusinessController;
use Modules\Accessory\Http\Controllers\BusinessLocationController;
use Modules\Accessory\Http\Controllers\CashRegisterController;
use Modules\Accessory\Http\Controllers\CategoryController;
use Modules\Accessory\Http\Controllers\CombinedPurchaseReturnController;
use Modules\Accessory\Http\Controllers\ContactController;
use Modules\Accessory\Http\Controllers\CustomerGroupController;
use Modules\Accessory\Http\Controllers\DashboardConfiguratorController;
use Modules\Accessory\Http\Controllers\DiscountController;
use Modules\Accessory\Http\Controllers\DocumentAndNoteController;
use Modules\Accessory\Http\Controllers\ExpenseCategoryController;
use Modules\Accessory\Http\Controllers\ExpenseController;
use Modules\Accessory\Http\Controllers\GroupTaxController;
use Modules\Accessory\Http\Controllers\HomeController;
use Modules\Accessory\Http\Controllers\ImportOpeningStockController;
...
use Modules\Accessory\Http\Controllers\LedgerDiscountController;
use Modules\Accessory\Http\Controllers\LocationSettingsController;
use Modules\Accessory\Http\Controllers\ManageUserController;
use Modules\Accessory\Http\Controllers\NotificationController;
use Modules\Accessory\Http\Controllers\NotificationTemplateController;
use Modules\Accessory\Http\Controllers\OpeningStockController;
use Modules\Accessory\Http\Controllers\PrinterController;
use Modules\Accessory\Http\Controllers\ProductController;
use Modules\Accessory\Http\Controllers\PurchaseController;
use Modules\Accessory\Http\Controllers\PurchaseOrderController;
use Modules\Accessory\Http\Controllers\PurchaseRequisitionController;
use Modules\Accessory\Http\Controllers\PurchaseReturnController;
use Modules\Accessory\Http\Controllers\ReportController;
use Modules\Accessory\Http\Controllers\Restaurant;
use Modules\Accessory\Http\Controllers\RoleController;
use Modules\Accessory\Http\Controllers\SalesCommissionAgentController;
use Modules\Accessory\Http\Controllers\SalesOrderController;
use Modules\Accessory\Http\Controllers\SellController;
use Modules\Accessory\Http\Controllers\SellingPriceGroupController;
use Modules\Accessory\Http\Controllers\SellPosController;
use Modules\Accessory\Http\Controllers\SellReturnController;
use Modules\Accessory\Http\Controllers\StockAdjustmentController;
use Modules\Accessory\Http\Controllers\StockTransferController;
use Modules\Accessory\Http\Controllers\TaxonomyController;
use Modules\Accessory\Http\Controllers\TaxRateController;
use Modules\Accessory\Http\Controllers\TransactionPaymentController;
use Modules\Accessory\Http\Controllers\TypesOfServiceController;
use Modules\Accessory\Http\Controllers\UnitController;
use Modules\Accessory\Http\Controllers\UserController;
use Modules\Accessory\Http\Controllers\VariationTemplateController;
use Modules\Accessory\Http\Controllers\WarrantyController;
...
Route::middleware(['setData', 'auth', 'accessory.database', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
...
//common route
Route::middleware(['auth', 'accessory.database'])->group(function () {
    Route::get('/logout', [Modules\Accessory\Http\Controllers\Auth\LoginController::class, 'logout'])->name('logout');
});

Route::middleware(['setData', 'auth', 'accessory.database', 'language', 'timezone'])->group(function () {
