...
class ProductModifierSetController extends Controller
{
    ...
    public function edit($id)
    {
        if (request()->ajax()) {
            ...
            return view('accessory::restaurant.product_modifier_set.edit')
    ...
    public function product_row($product_id)
    {
        if (request()->ajax()) {
            ...
            return view('accessory::restaurant.product_modifier_set.product_row')
    ...
    public function add_selected_modifiers(Request $request)
    {
        ...
        if (count($modifiers) > 0) {
            return view('accessory::restaurant.product_modifier_set.add_selected_modifiers')
