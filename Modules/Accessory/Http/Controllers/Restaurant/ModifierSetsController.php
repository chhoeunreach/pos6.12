...
namespace Modules\Accessory\Http\Controllers\Restaurant;
...
class ModifierSetsController extends Controller
{
    ...
    public function index()
    {
        if (request()->ajax()) {
            ...
            return \Datatables::of($modifer_set)
                ->addColumn(
                    ...
                    '
                    @can("product.update")
                        <button type="button" data-href="{{action(\'Modules\Accessory\Http\Controllers\Restaurant\ModifierSetsController@edit\', [$id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary edit_modifier_button" data-container=".modifier_modal"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                        &nbsp;
                        <button type="button" data-href="{{action(\'Modules\Accessory\Http\Controllers\Restaurant\ProductModifierSetController@edit\', [$id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-info edit_modifier_button" data-container=".modifier_modal"><i class="fa fa-cubes"></i> @lang("restaurant.manage_products")</button>
                    &nbsp;
                    @endcan

                    @can("product.delete")
                        <button data-href="{{action(\'Modules\Accessory\Http\Controllers\Restaurant\ModifierSetsController@destroy\', [$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_modifier_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                    @endcan
                    '
                )
        ...
        return view('accessory::restaurant.modifier_sets.index');
    }
    ...
    public function create()
    {
        ...
        return view('accessory::restaurant.modifier_sets.create');
    }
    ...
    {
        return view('accessory::restaurant.modifier_sets.show');
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        try {
            ...
            return view('accessory::restaurant.modifier_sets.edit')
