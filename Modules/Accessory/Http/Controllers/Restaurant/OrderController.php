...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('accessory::restaurant.orders.index', compact('orders', 'is_service_staff', 'service_staff', 'line_orders'));
    }
    ...
    public function printLineOrder(Request $request)
    {
        try {
            ...
            $order = $line_orders[0];
            $html_content = view('accessory::restaurant.partials.print_line_order', compact('order'))->render();
            $output = [
                'success' => 1,
