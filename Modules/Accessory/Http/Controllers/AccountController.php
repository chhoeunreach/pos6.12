...
class AccountController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($accounts)
                            ->addColumn(
                                'action',
                                '<button data-href="{{action(\'Modules\Accessory\Http\Controllers\AccountController@edit\',[$id])}}" data-container=".account_model" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary btn-modal"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                                <a href="{{action(\'Modules\Accessory\Http\Controllers\AccountController@show\',[$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-warning btn-xs"><i class="fa fa-book"></i> @lang("account.account_book")</a>&nbsp;
                                @if($is_closed == 0)
                                <button data-href="{{action(\'Modules\Accessory\Http\Controllers\AccountController@getFundTransfer\',[$id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-info btn-modal" data-container=".view_modal"><i class="fas fa-calculator"></i> @lang("account.fund_transfer")</button>

                                <button data-href="{{action(\'Modules\Accessory\Http\Controllers\AccountController@getDeposit\',[$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-success btn-modal" data-container=".view_modal"><i class="fas fa-money-bill-alt"></i> @lang("account.deposit")</button>

                                <button data-url="{{action(\'Modules\Accessory\Http\Controllers\AccountController@close\',[$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error close_account"><i class="fa fa-power-off"></i> @lang("messages.close")</button>
                                @elseif($is_closed == 1)
                                    <button data-url="{{action(\'Modules\Accessory\Http\Controllers\AccountController@activate\',[$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-success activate_account"><i class="fa fa-power-off"></i> @lang("messages.activate")</button>
                                @endif'
                            )
        ...
        return view('accessory::account.index')
    ...
    public function create()
    {
        ...
        return view('accessory::account.create')
    ...
    public function show($id)
    {
                            ...
                            ->editColumn('action', function ($row) {
                                ...
                                if (auth()->user()->can('delete_account_transaction')) {
                                    if ($row->sub_type == 'fund_transfer' || $row->sub_type == 'deposit') {
                                        $action .= '<button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-error delete_account_transaction" data-href="'.action([\Modules\Accessory\Http\Controllers\AccountController::class, 'destroyAccountTransaction'], [$row->id]).'"><i class="fa fa-trash"></i> '.__('messages.delete').'</button>';
                                    }
                                }
                                if (auth()->user()->can('edit_account_transaction')) {
                                    if ($row->sub_type == 'fund_transfer' || $row->sub_type == 'deposit' || $row->sub_type == 'opening_balance') {
                                        $action .= ' <button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-primary btn-modal" data-container="#edit_account_transaction" data-href="'.action([\Modules\Accessory\Http\Controllers\AccountController::class, 'editAccountTransaction'], [$row->id]).'"><i class="fa fa-edit"></i> '.__('messages.edit').'</button>';
                                    }
                                }
        ...
        return view('accessory::account.show')
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('accessory::account.edit')
    ...
    public function getFundTransfer($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('accessory::account.transfer')
    ...
    public function postFundTransfer(Request $request)
    {
        ...
        return redirect()->action([\Modules\Accessory\Http\Controllers\AccountController::class, 'index'])->with('status', $output);
    }
    ...
    public function getDeposit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('accessory::account.deposit')
    ...
    public function cashFlow()
    {
        ...
        return view('accessory::account.cash_flow')
        ...
        if (! empty($row->sub_type)) {
            ...
            if (! empty($row->transaction->type)) {
                if ($row->transaction->type == 'purchase') {
                    ...
                    __('purchase.ref_no').':</b> <a href="#" data-href="'.action([\Modules\Accessory\Http\Controllers\PurchaseController::class, 'show'], [$row->transaction->id]).'" class="btn-modal" data-container=".view_modal">'.$row->transaction->ref_no.'</a>';
                    ...
                    __('sale.invoice_no').':</b> <a href="#" data-href="'.action([\Modules\Accessory\Http\Controllers\SellController::class, 'show'], [$row->transaction->id]).'" class="btn-modal" data-container=".view_modal">'.$row->transaction->invoice_no.'</a>';
                }
            } else {
    ...
    public function editAccountTransaction($id)
    {
        ...
        return view('accessory::account.edit_account_transaction')
