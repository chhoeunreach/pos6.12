...
class GroupTaxController extends Controller
{
    ...
    public function index()
    {
        if (request()->ajax()) {
            ...
            return Datatables::of($tax_rates)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'Modules\Accessory\Http\Controllers\GroupTaxController@edit\', [$id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary btn-modal" data-container=".tax_group_modal"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                        &nbsp;
                        <button data-href="{{action(\'Modules\Accessory\Http\Controllers\GroupTaxController@destroy\', [$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_tax_group_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>'
                )
    ...
    public function create()
    {
        ...
        return view('accessory::tax_group.create')
                ->with(compact('taxes'));
    }
    ...
    public function edit($id)
    {
        if (request()->ajax()) {
            ...
            return view('accessory::tax_group.edit')
