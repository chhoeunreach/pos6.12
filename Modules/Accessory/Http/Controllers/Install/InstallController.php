...
class InstallController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('accessory::install.index');
    }
    ...
    public function checkServer()
    {
        ...
        return view('accessory::install.check-server')
            ->with(compact('output'));
    }
    ...
    public function details()
    {
        ...
        return view('accessory::install.details')
    ...
    public function postDetails(Request $request)
    {
        ...
        try {
            ...
            if (false) {
                ...
                // return redirect()->route('accessory.install.success');
            } else {
                $this->deleteEnv();
                ...
                return view('accessory::install.envText')
    ...
    public function installAlternate(Request $request)
    {
        try {
            ...
            $envPath = base_path('.env');
            if (! file_exists($envPath)) {
                return redirect()->route('accessory.install.details')
    ...
    {
        return view('accessory::install.success');
    }
    ...
    public function updateConfirmation()
    {
        ...
        if (Comparator::greaterThan($this->appVersion, $db_version)) {
            return view('accessory::install.update_confirmation');
        } else {
            // abort(404);
