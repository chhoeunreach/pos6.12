...
class TaxonomyController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($category)
                ->addColumn('action', function ($row) use ($can_edit, $can_delete, $category_type) {
                    $html = '';
                    if ($can_edit) {
                        $html .= '<button data-href="' . action([\Modules\Accessory\Http\Controllers\TaxonomyController::class, 'edit'], [$row->id]) . '?type=' . $category_type . '" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary edit_category_button"><i class="glyphicon glyphicon-edit"></i> ' . __('messages.edit') . '</button>';
                    }

                    if ($can_delete) {
                        $html .= '&nbsp;<button data-href="' . action([\Modules\Accessory\Http\Controllers\TaxonomyController::class, 'destroy'], [$row->id]) . '" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_category_button"><i class="glyphicon glyphicon-trash"></i> ' . __('messages.delete') . '</button>';
                    }
        ...
        return view('accessory::taxonomy.index')->with(compact('module_category_data', 'module_category_data'));
    }
    ...
    public function create()
    {
        ...
        return view('accessory::taxonomy.create')
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('accessory::taxonomy.edit')
    ...
    public function getTaxonomyIndexPage(Request $request)
    {
        if (request()->ajax()) {
            ...
            return view('accessory::taxonomy.ajax_index')
