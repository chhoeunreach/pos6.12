...
class CashRegisterController extends Controller
{
    ...
    {
        return view('accessory::cash_register.index');
    }
    ...
    public function create()
    {
        ...
        if ($this->cashRegisterUtil->countOpenedRegister() != 0) {
            return redirect()->action([\Modules\Accessory\Http\Controllers\SellPosController::class, 'create'], ['sub_type' => $sub_type]);
        }
        $business_id = request()->session()->get('user.business_id');
        $business_locations = BusinessLocation::forDropdown($business_id);

        return view('accessory::cash_register.create')->with(compact('business_locations', 'sub_type'));
    }
    ...
    public function show($id)
    {
        ...
        return view('accessory::cash_register.register_details')
    ...
    public function getCloseRegister($id = null)
    {
        ...
        return view('accessory::cash_register.close_register_modal')
    ...
    public function postCloseRegister(Request $request)
    {
        ...
        try {
            ...
            if (config('app.env') == 'demo') {
                ...
                return redirect()->action([\Modules\Accessory\Http\Controllers\HomeController::class, 'index'])->with('status', $output);
            }
