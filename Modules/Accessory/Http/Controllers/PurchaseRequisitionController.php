...
class PurchaseRequisitionController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($purchase_requisitions)
                ->addColumn('action', function ($row) {
                    ...
                    $html .= '<li><a href="#" data-href="'.action([\Modules\Accessory\Http\Controllers\PurchaseRequisitionController::class, 'show'], [$row->id]).'" class="btn-modal" data-container=".view_modal"><i class="fas fa-eye" aria-hidden="true"></i>'.__('messages.view').'</a></li>';

                    if (auth()->user()->can('purchase_requisition.delete')) {
                        $html .= '<li><a href="'.action([\Modules\Accessory\Http\Controllers\PurchaseRequisitionController::class, 'destroy'], [$row->id]).'" class="delete-purchase-requisition"><i class="fas fa-trash"></i>'.__('messages.delete').'</a></li>';
                    }
                ...
                ->setRowAttr([
                    'data-href' => function ($row) {
                        return  action([\Modules\Accessory\Http\Controllers\PurchaseRequisitionController::class, 'show'], [$row->id]);
                    }, ])
        ...
        return view('accessory::purchase_requisition.index')->with(compact('business_locations', 'purchaseRequisitionStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('accessory::purchase_requisition.create')->with(compact('business_locations', 'categories', 'brands'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action([\Modules\Accessory\Http\Controllers\PurchaseRequisitionController::class, 'index'])->with('status', $output);
    }
    ...
    public function show($id)
    {
        ...
        return view('accessory::purchase_requisition.show')
    ...
    public function getRequisitionProducts()
    {
        if (request()->ajax()) {
            ...
            return view('accessory::purchase_requisition.product_list')->with(compact('products'));
        }
    }
    ...
    public function getPurchaseRequisitionLines($purchase_requisition_id)
    {
        ...
        $html = view('accessory::purchase_requisition.partials.purchase_requisition_lines')
                ->with(compact(
