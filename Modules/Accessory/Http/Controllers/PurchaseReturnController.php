...
class PurchaseReturnController extends Controller
{
    ...
    public function index()
    {
            ...
            return Datatables::of($purchases_returns)
                ->addColumn('action', function ($row) {
                    ...
                    if (! empty($row->return_parent_id)) {
                        $html .= '<li><a href="'.action([\Modules\Accessory\Http\Controllers\PurchaseReturnController::class, 'add'], $row->return_parent_id).'" ><i class="glyphicon glyphicon-edit"></i>'.
                                __('messages.edit').
                                '</a></li>';
                    } else {
                        $html .= '<li><a href="'.action([\Modules\Accessory\Http\Controllers\CombinedPurchaseReturnController::class, 'edit'], $row->id).'" ><i class="glyphicon glyphicon-edit"></i>'.
                                __('messages.edit').
                                '</a></li>';
                    }
                    ...
                    $html .= '<li><a href="'.action([\Modules\Accessory\Http\Controllers\PurchaseReturnController::class, 'destroy'], $row->id).'" class="delete_purchase_return" ><i class="fa fa-trash"></i>'.
                                __('messages.delete').
                                '</a></li>';
                    $html .= '</ul></div>';
                ...
                ->setRowAttr([
                    'data-href' => function ($row) {
                        if (auth()->user()->can('purchase.view')) {
                            ...
                            return  action([\Modules\Accessory\Http\Controllers\PurchaseReturnController::class, 'show'], [$return_id]);
                        } else {
                            return '';
                        }
                    }, ])
        ...
        return view('accessory::purchase_return.index')->with(compact('business_locations'));
    }
    ...
    public function add($id)
    {
        ...
        return view('accessory::purchase_return.add')
    ...
    public function show($id)
    {
        ...
        return view('accessory::purchase_return.show')
