...
class BusinessController extends Controller
{
    ...
    */
    ...
    public function getRegister()
    {
        ...
        return view('accessory::business.register', compact(
            'currencies',
            'timezone_list',
            'months',
            'accounting_methods',
    ...
    public function postRegister(Request $request)
    {
        ...
        try {
            ...
            if (config('app.env') != 'demo') {
                $this->getAccessoryModuleData($this->moduleUtil, 'after_business_created', ['business' => $business]);
            }
            ...
            if ($is_installed_superadmin && ! empty($package_id) && (config('app.env') != 'demo')) {
                ...
                if (! empty($package)) {
                    Auth::login($user);
                    return redirect()->route('accessory.register-pay', ['package_id' => $package_id]);
                }
            }
    ...
    public function testEmailConfiguration(Request $request)
    {
        try {
            ...
            \Notification::route('accessory.mail', $email_settings['mail_from_address'])
