...
class NotificationTemplateController extends Controller
{
    ...
    public function index()
    {
        ...
        $module_customer_notifications = $this->getAccessoryModuleData($this->moduleUtil, 'notification_list', ['notification_for' => 'customer']);
        ...
        $module_supplier_notifications = $this->getAccessoryModuleData($this->moduleUtil, 'notification_list', ['notification_for' => 'supplier']);
        ...
        return view('accessory::notification_template.index')
