...
class BarcodeController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($barcodes)
                ->addColumn(
                    'action',
                    '<a href="{{action(\'Modules\Accessory\Http\Controllers\BarcodeController@edit\', [$id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</a>
                        &nbsp;
                        <button type="button" data-href="{{action(\'Modules\Accessory\Http\Controllers\BarcodeController@destroy\', [$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_barcode_button" @if($is_default) disabled @endif><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>&nbsp;
                        @if($is_default)
                        ...
                        @else
                            <button class="btn btn-xs btn-info set_default" data-href="{{action(\'Modules\Accessory\Http\Controllers\BarcodeController@setDefault\', [$id])}}">@lang("barcode.set_as_default")</button>
                        @endif
                        '
                )
        ...
        return view('accessory::barcode.index');
    }
    ...
    public function create()
    {
        ...
        return view('accessory::barcode.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('accessory::barcode.edit')
