...
class LabelsController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        return view('accessory::labels.show')
    ...
    public function addProductRow(Request $request)
    {
        if ($request->ajax()) {
            ...
            if (! empty($product_id)) {
                ...
                return view('accessory::labels.partials.show_table_rows')
    ...
    public function preview(Request $request)
    {
        try {
            ...
            foreach ($product_details_page_wise as $page => $page_products) {
                ...
                $output = view('accessory::labels.partials.preview_2')
            ...
            // $output = view('accessory::labels.partials.preview')
