...
class AccountReportsController extends Controller
{
    ...
    public function balanceSheet()
    {
        ...
        return view('accessory::account_reports.balance_sheet')->with(compact('business_locations'));
    }
    ...
    public function trialBalance()
    {
        ...
        return view('accessory::account_reports.trial_balance')->with(compact('business_locations'));
    }
    ...
    public function paymentAccountReport()
    {
        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($query)
                    ...
                    ->addColumn('action', function ($row) {
                        ...
                        data-href="'.action([\Modules\Accessory\Http\Controllers\AccountReportsController::class, 'getLinkAccount'], [$row->payment_id]).'">'.__('account.link_account').'</button>';
                    ...
                    ->addColumn('transaction_number', function ($row) {
                        ...
                        if ($row->type == 'sell') {
                            $html = '<button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-info btn-modal"
                                    data-href="'.action([\Modules\Accessory\Http\Controllers\SellController::class, 'show'], [$row->transaction_id]).'" data-container=".view_modal">'.$row->invoice_no.'</button>';
                        } elseif ($row->type == 'purchase') {
                            $html = '<button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-info btn-modal"
                                    data-href="'.action([\Modules\Accessory\Http\Controllers\PurchaseController::class, 'show'], [$row->transaction_id]).'" data-container=".view_modal">'.$row->ref_no.'</button>';
                        }
        ...
        return view('accessory::account_reports.payment_account_report')
    ...
    public function getLinkAccount($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('accessory::account_reports.link_account_modal')
