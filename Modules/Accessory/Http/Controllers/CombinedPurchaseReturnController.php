...
class CombinedPurchaseReturnController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('accessory::purchase_return.create')
    ...
    public function edit($id)
    {
        ...
        return view('accessory::purchase_return.edit')
    ...
    public function getProductRow(Request $request)
    {
        if (request()->ajax()) {
            ...
            return view('accessory::purchase_return.partials.product_table_row')
