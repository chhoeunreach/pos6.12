...
{!! Form::open(['url' => action([\Modules\Accessory\Http\Controllers\ManageUserController::class, 'store']), 'method' => 'post', 'id' => 'user_add_form' ]) !!}
  <div class="row">
    <div class="col-md-12">
  ...
  <div class="col-md-12">
    ...
    @include('accessory::user.edit_profile_form_part')
