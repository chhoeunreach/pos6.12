...
<section class="content">
    {!! Form::open(['url' => action([\Modules\Accessory\Http\Controllers\ManageUserController::class, 'update'], [$user->id]), 'method' => 'PUT', 'id' => 'user_edit_form']) !!}
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
        @component('accessory::components.widget', ['title' => __('lang_v1.roles_and_permissions')])
            <div class="col-md-4">
                <div class="form-group">
                    <div class="checkbox">
                      <label>
        ...
        <div class="col-md-12">
            @component('accessory::components.widget', ['title' => __('sale.sells')])
