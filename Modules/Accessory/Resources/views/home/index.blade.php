...
@section('javascript')
    @include('accessory::home.partials.home_js')
    <script src="{{ asset('modules/accessory/v7/js/payment.js?v=' . $asset_v) }}"></script>
    @includeIf('accessory::sales_order.common_js')
    @includeIf('accessory::purchase_order.common_js')
    @if (!empty($all_locations))
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            sales_order_table = $('#sales_order_table').DataTable({
                ...
                "ajax": {
                    "url": '{{ action([\Modules\Accessory\Http\Controllers\SellController::class, 'index']) }}?sale_type=sales_order',
                    "data": function(d) {
            ...
            @if (auth()->user()->can('account.access') && config('constants.show_payments_recovered_today') == true)
                ...
                cash_flow_table = $('#cash_flow_table').DataTable({
                    ...
                    fixedHeader:false,
                    "ajax": {
                        "url": "{{ action([\Modules\Accessory\Http\Controllers\AccountController::class, 'cashFlow']) }}",
                        "data": function(d) {
                            d.type = 'credit';
            ...
            @if (!empty($common_settings['enable_purchase_order']))
                ...
                purchase_order_table = $('#purchase_order_table').DataTable({
                    ...
                    scrollCollapse: true,
                    ajax: {
                        url: '{{ action([\Modules\Accessory\Http\Controllers\PurchaseOrderController::class, 'index']) }}',
                        data: function(d) {
            ...
            @if (!empty($common_settings['enable_purchase_requisition']))
                ...
                purchase_requisition_table = $('#purchase_requisition_table').DataTable({
                    ...
                    scrollCollapse: true,
                    ajax: {
                        url: '{{ action([\Modules\Accessory\Http\Controllers\PurchaseRequisitionController::class, 'index']) }}',
                        data: function(d) {
                            d.from_dashboard = true;
            ...
            sell_table = $('#shipments_table').DataTable({
                ...
                scrollCollapse: true,
                "ajax": {
                    "url": '{{ action([\Modules\Accessory\Http\Controllers\SellController::class, 'index']) }}',
                    "data": function(d) {
