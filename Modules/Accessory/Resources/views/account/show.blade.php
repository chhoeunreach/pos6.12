...
<script>
    $(document).ready(function(){
        ...
        account_book = $('#account_book').DataTable({
                            ...
                            fixedHeader:false,
                            ajax: {
                                url: '{{action([\Modules\Accessory\Http\Controllers\AccountController::class, 'show'],[$account->id])}}',
                                data: function(d) {
                                    var start = '';
                                    var end = '';
    ...
    function update_account_balance(argument) {
        ...
        $.ajax({
            url: '{{action([\Modules\Accessory\Http\Controllers\AccountController::class, 'getAccountBalance'], [$account->id])}}',
            dataType: "json",
