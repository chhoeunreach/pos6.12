...
@section('content')
    ...
    <section class="content">
        @component('accessory::components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_variations')])
            @slot('tool')
                <div class="box-tools">
                    ...
                    data-href="{{action([\Modules\Accessory\Http\Controllers\VariationTemplateController::class, 'create'])}}" 
