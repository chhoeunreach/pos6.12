	...
	@forelse($medias as $media)
		<tr>
			...
			<td>
				...
				@if(!empty($delete))
					<button type="button" data-href="{{action([\Modules\Accessory\Http\Controllers\ProductController::class, 'deleteMedia'], [$media->id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-error delete-media no-print"><i class="fas fa-trash"></i> @lang('messages.delete')</a>
				@endif
			</td>
		</tr>
	@empty
