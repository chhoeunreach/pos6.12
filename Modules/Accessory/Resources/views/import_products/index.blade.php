...
<section class="content">
    ...
    <div class="row">
        <div class="col-sm-12">
            @component('accessory::components.widget', ['class' => 'box-primary'])
                {!! Form::open(['url' => action([\Modules\Accessory\Http\Controllers\ImportProductsController::class, 'store']), 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
                    <div class="row">
                        <div class="col-sm-6">
                        <div class="col-sm-8">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a href="{{ action([\Modules\Accessory\Http\Controllers\ImportProductsController::class, 'downloadImportTemplate']) }}" class="tw-dw-btn tw-dw-btn-success tw-text-white"><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                    </div>
                </div>
            @endcomponent
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            @component('accessory::components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.instructions')])
