            ...
            <div class="">
                ...
                <div class="tab-content">
                            ...
                            <div class="col-md-12">
                                <h4>@lang( 'invoice.all_your_invoice_schemes' )
                                        <button class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right tw-mb-2 btn-modal"
                                            data-href="{{action([\Modules\Accessory\Http\Controllers\InvoiceSchemeController::class, 'create'])}}" 
                    ...
                    <div class="tab-pane" id="tab_2">
                        <div class="row">
                            <div class="col-md-12">
                                <h4>@lang( 'invoice.all_your_invoice_layouts' ) <a class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm pull-right" href="{{action([\Modules\Accessory\Http\Controllers\InvoiceLayoutController::class, 'create'])}}">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="icon-link">
                                        <a href="{{action([\Modules\Accessory\Http\Controllers\InvoiceLayoutController::class, 'edit'], [$layout->id])}}">
