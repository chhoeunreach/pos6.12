	...
	<div class="modal-content">
	    ...
	    <div class="modal-body">
      		...
      		@if($product->type == 'single')
      			@include('accessory::product.partials.single_product_details')
      		@elseif($product->type == 'variable')
      			@include('accessory::product.partials.variable_product_details')
      		@elseif($product->type == 'combo')
      			@include('accessory::product.partials.combo_product_details')
      		@endif
