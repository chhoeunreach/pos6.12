...
@if (isset($transaction))
    @include('accessory::sale_pos.partials.edit_discount_modal', [
...
@if (isset($transaction))
    @include('accessory::sale_pos.partials.edit_order_tax_modal', ['selected_tax' => $transaction->tax_id])
@else
    @include('accessory::sale_pos.partials.edit_order_tax_modal', [
        'selected_tax' => $business_details->default_sales_tax,
    ])
@endif

@include('accessory::sale_pos.partials.edit_shipping_modal')
