...
<div class="sell-list-pane sell-list-pane-active is-active">
    @include('accessory::sale_pos.partials.hr_sell_list_rows', ['reports' => $activeReports, 'line_status' => 'active', 'show_copy_button' => true])
...
<div class="sell-list-pane sell-list-pane-added">
    @include('accessory::sale_pos.partials.hr_sell_list_rows', ['reports' => $addedReports, 'line_status' => 'added', 'show_copy_button' => false])
