			...
			<div class="row tw-flex lg:tw-flex-row md:tw-flex-col sm:tw-flex-col tw-flex-col tw-items-stretch" style="gap: 4px; margin: 0; padding: 0;">
					...
					<div class="tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] tw-rounded-2xl tw-bg-white" style="padding:0;overflow:hidden;height:100%;">
						<div class="box-body pb-0">
							...
							<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
								@include('accessory::sale_pos.partials.pos_form_edit')

								@include('accessory::sale_pos.partials.pos_form_totals', ['edit' => true])
				...
				@if(empty($pos_settings['hide_product_suggestion'])  && !isMobile() && empty($only_payment))
					<div class="tw-w-full lg:tw-w-[40%]" style="padding:0;" id="pos_sidebar_wrap">
						@include('accessory::sale_pos.partials.pos_sidebar')
					</div>
				@endif
			</div>
		</div>
	</div>
	@include('accessory::sale_pos.partials.pos_form_actions', ['edit' => true])
	{!! Form::close() !!}
</section>
...
@if(empty($pos_settings['hide_product_suggestion']) && isMobile())
	@include('accessory::sale_pos.partials.mobile_product_suggestions')
@endif
<!-- /.content -->
...
@include('accessory::sale_pos.partials.recent_transactions_modal')

@include('accessory::sale_pos.partials.weighing_scale_modal')
...
@section('javascript')
	...
	@include('accessory::sale_pos.partials.pos_layout_script', ['form_id' => 'edit_pos_sell_form'])
