...
<section class="content no-print">
	...
	<div class="row">
		<div class="@if(!empty($pos_settings['hide_product_suggestion']) && !empty($pos_settings['hide_recent_trans'])) col-md-10 col-md-offset-1 @else col-md-7 @endif col-sm-12">
			@component('accessory::components.widget', ['class' => 'box-success'])
				@slot('header')
					<div class="col-sm-6">
						<h3 class="box-title">POS Terminal <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('accessory::sale_pos.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h3>
					</div>
					<div class="col-sm-6">
				...
				@endslot
				{!! Form::open(['url' => route('accessory.pos.store'), 'method' => 'post', 'id' => 'add_pos_sell_form' ]) !!}
				...
				<div class="box-body">
					...
					@include('accessory::sale_pos.partials.pos_details')
