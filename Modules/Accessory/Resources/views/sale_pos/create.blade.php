...
@section('content')
    <section class="content no-print">
                        ...
                        <div class="tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] tw-rounded-2xl tw-bg-white" style="padding:0;overflow:hidden;height:100%;">
                            ...
                            {{-- <div class="box box-solid mb-12 @if (!isMobile()) mb-40 @endif"> --}}
                                <div class="box-body pb-0">
                                    ...
                                    @include('accessory::sale_pos.partials.pos_form')

                                    @include('accessory::sale_pos.partials.pos_form_totals')
        ...
        @include('accessory::sale_pos.partials.pos_form_actions')
        {!! Form::close() !!}
    </section>
...
@section('javascript')
    ...
    @if (!empty($pos_module_data))
        ...
        @endforeach
    @endif
    @include('accessory::sale_pos.partials.pos_layout_script', ['form_id' => 'add_pos_sell_form'])
@endsection
