...
<section class="content no-print">
	{!! Form::open(['url' => action([\Modules\Accessory\Http\Controllers\StockTransferController::class, 'update'], [$sell_transfer->id]), 'method' => 'put', 'id' => 'stock_transfer_form' ]) !!}
					...
					id="stock_adjustment_product_table">
						...
						<tbody>
							...
							@foreach($products as $product)
								@include('accessory::stock_transfer.partials.product_table_row', ['product' => $product, 'row_index' => $loop->index, 'sub_units' => !empty($product->unit_details) ? $product->unit_details : []])
								@php
