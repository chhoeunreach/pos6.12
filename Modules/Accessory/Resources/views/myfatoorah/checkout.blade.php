    ...
    <body dir="{{App::isLocale('ar') ? 'rtl' : 'ltr'}}">
        ...
        <div class="mf-payment-methods-container" id="mf-paymentGateways" >
            ...
            <div id="mf-sectionCard">
                ...
                <div id="mf-cards">
                    @include('accessory::myfatoorah.includes.sectionCards')
                </div>
            </div>
            @endif
            ...
            <!-- Google Pay Scripts -->
            @if(!empty($paymentMethods['gp']))
            @include('accessory::myfatoorah.includes.sectionGooglePay')
            @endif

            <!-- Apple Pay Scripts -->
            @if(!empty($paymentMethods['ap']))
            @include('accessory::myfatoorah.includes.sectionApplePay')
            @endif

            <!-- Payment Form Scripts -->
            @if(!empty($paymentMethods['form']))
            @include('accessory::myfatoorah.includes.sectionForm')
            @endif
        </div>
    </body>
</html>