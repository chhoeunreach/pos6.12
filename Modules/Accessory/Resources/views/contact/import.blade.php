    ...
    <div class="row">
        <div class="col-sm-12">
            @component('accessory::components.widget', ['class' => 'box-primary'])
                {!! Form::open(['url' => action([\Modules\Accessory\Http\Controllers\ContactController::class, 'postImportContacts']), 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
                    <div class="row">
                        <div class="col-sm-6">
                        <div class="col-sm-8">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a href="{{ asset('modules/accessory/v7/files/import_contacts_csv_template.xls') }}" class="tw-dw-btn tw-dw-btn-success tw-text-white" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                    </div>
                </div>
            @endcomponent
        </div>
