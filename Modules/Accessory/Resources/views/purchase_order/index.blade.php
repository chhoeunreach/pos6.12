...
@section('content')
    ...
    <section class="content no-print">
        ...
        @endcomponent
        @component('accessory::components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_purchase_orders')])
            @can('purchase_order.create')
                @slot('tool')
                    <div class="box-tools">
                        <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right"
                            href="{{ action([\Modules\Accessory\Http\Controllers\PurchaseOrderController::class, 'create']) }}">
