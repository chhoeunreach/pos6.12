    ...
    @component('accessory::components.widget', ['class' => 'box-primary'])
        @can('user.create')
            @slot('tool')
                <div class="box-tools">                
                        ...
                        data-href="{{action([\Modules\Accessory\Http\Controllers\SalesCommissionAgentController::class, 'create'])}}" data-container=".commission_agent_modal">
        ...
        @can('user.view')
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="sales_commission_agent_table" data-href="{{ action([\Modules\Accessory\Http\Controllers\SalesCommissionAgentController::class, 'index']) }}">
                    <thead>
                        <tr>
