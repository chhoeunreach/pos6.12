...
<section class="content no-print">
	{!! Form::open(['url' => action([\Modules\Accessory\Http\Controllers\CombinedPurchaseReturnController::class, 'update']), 'method' => 'post', 'id' => 'purchase_return_form', 'files' => true ]) !!}
					...
					id="purchase_return_product_table">
						...
						<tbody>
							@foreach($purchase_lines as $purchase_line)
								@include('accessory::purchase_return.partials.product_table_row', ['product' => $purchase_line, 'row_index' => $loop->index, 'edit' => true])
