...
@section('content')
    ...
    <section class="content">
        ...
        @endphp
        @component('accessory::components.widget', ['class' => 'box-solid', 'can_add' => $can_add])
            @if ($can_add)
                @slot('tool')
                    <div class="box-tools">
                        {{-- <button type="button" class="btn btn-block btn-primary btn-modal" 
                    data-href="{{action([\Modules\Accessory\Http\Controllers\TaxonomyController::class, 'create'])}}?type={{request()->get('type')}}" 
...
@stop
@section('javascript')
    @includeIf('accessory::taxonomy.taxonomies_js')
@endsection
