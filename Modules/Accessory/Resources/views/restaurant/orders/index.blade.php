@extends('accessory::layouts.restaurant')
...
<section class="content min-height-90hv no-print">
    ...
    @if(!$is_service_staff)
        @component('accessory::components.widget')
            <div class="col-sm-6">
                {!! Form::open(['url' => action([\Modules\Accessory\Http\Controllers\Restaurant\OrderController::class, 'index']), 'method' => 'get', 'id' => 'select_service_staff_form' ]) !!}
        ...
        @endcomponent
    @endif
    @component('accessory::components.widget', ['title' => __( 'lang_v1.line_orders' )])
        <input type="hidden" id="orders_for" value="waiter">
        <div class="row" id="line_orders_div">
         @include('accessory::restaurant.partials.line_orders', array('orders_for' => 'waiter'))   
        </div>
    ...
    @component('accessory::components.widget', ['title' => __( 'restaurant.all_your_orders' )])
        <input type="hidden" id="orders_for" value="waiter">
        <div class="row" id="orders_div">
         @include('accessory::restaurant.partials.show_orders', array('orders_for' => 'waiter'))   
        </div>
        <div class="overlay hide">
          <i class="fas fa-sync fa-spin"></i>
        </div>
