...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => $notification_template['template_for'] == 'send_ledger' ? action([\Modules\Accessory\Http\Controllers\ContactController::class, 'sendLedger']) : action([\Modules\Accessory\Http\Controllers\NotificationController::class, 'send']), 'method' => 'post', 'id' => 'send_notification_form' ]) !!}
    ...
    <div class="modal-body">
        <div>
            ...
            @include('accessory::notification_template.partials.tags', ['tags' => $tags])
        </div>
