...
<section class="content">
    @component('accessory::components.widget', ['class' => 'box-primary', 'title' => __( 'expense.all_your_expense_categories' )])
        @slot('tool')
            <div class="box-tools">
                ...
                <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full btn-modal pull-right"
                    data-href="{{action([\Modules\Accessory\Http\Controllers\ExpenseCategoryController::class, 'create'])}}" 
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <p class="help-block">
                                    <a href="{{ action([\Modules\Accessory\Http\Controllers\ExpenseCategoryController::class, 'downloadTemplate']) }}">
...
<script>
    $(document).ready(function() {
        ...
        $('#exp_cat_preview_btn').click(function() {
            ...
            $.ajax({
                method: 'POST',
                url: '{{ action([\Modules\Accessory\Http\Controllers\ExpenseCategoryController::class, 'importPreview']) }}',
                data: formData,
                processData: false,
                contentType: false,
                dataType: 'json',
        ...
        $('#exp_cat_confirm_import_btn').click(function() {
            ...
            $.ajax({
                method: 'POST',
                url: '{{ action([\Modules\Accessory\Http\Controllers\ExpenseCategoryController::class, 'importConfirm']) }}',
                dataType: 'json',
                data: {
                    _token: '{{ csrf_token() }}',
                    token: token
        ...
        $('#exp_cat_export_btn').click(function() {
            ...
            var url = '{{ action([\Modules\Accessory\Http\Controllers\ExpenseCategoryController::class, 'export']) }}'
