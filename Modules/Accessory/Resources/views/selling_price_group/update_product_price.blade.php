...
<section class="content">
    ...
    @endif
    @component('accessory::components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.import_export_product_price')])
            <div class="row">
                <div class="col-sm-6">
                    <a href="{{action([\Modules\Accessory\Http\Controllers\SellingPriceGroupController::class, 'export'])}}" class="tw-dw-btn tw-dw-btn-primary tw-text-white">@lang('lang_v1.export_product_prices')</a>
                </div>
                <div class="col-sm-6">
                    {!! Form::open(['url' => action([\Modules\Accessory\Http\Controllers\SellingPriceGroupController::class, 'import']), 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
