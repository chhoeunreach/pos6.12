...
@section('content')
    ...
    <section class="content no-print">
        @component('accessory::components.filters', ['title' => __('report.filters')])
            <div class="col-md-3">
        ...
        @component('accessory::components.widget', ['class' => 'box-primary', 'title' => __('purchase.all_purchases')])
            @can('purchase.create')
                @slot('tool')
                    <div class="box-tools">
                        {{-- <a class="btn btn-block btn-primary" href="{{action([\Modules\Accessory\Http\Controllers\PurchaseController::class, 'create'])}}">
                    <i class="fa fa-plus"></i> @lang('messages.add')</a> --}}
                        <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right"
                            href="{{action([\Modules\Accessory\Http\Controllers\PurchaseController::class, 'create'])}}">
        ...
        @include('accessory::purchase.partials.update_purchase_status_modal')
...
@section('javascript')
    ...
    <script>
        ...
        var purchaseTableUrl = @json(action([\Modules\Accessory\Http\Controllers\PurchaseController::class, 'index']));
