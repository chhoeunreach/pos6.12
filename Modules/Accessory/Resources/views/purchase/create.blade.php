...
<section class="content-header">
    <div class="tw-flex tw-justify-between tw-items-center">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black use_ai_btn">@lang('purchase.add_purchase') <i class="fa fa-keyboard hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('accessory::purchase.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h1>
    </div>
</section>
...
<section class="content">
	...
	{!! Form::open(['url' => action([\Modules\Accessory\Http\Controllers\PurchaseController::class, 'store']), 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]) !!}
	...
	@endcomponent
	@component('accessory::components.widget', ['class' => 'box-primary', 'title' => __('purchase.add_payment')])
...
@include('accessory::purchase.partials.import_purchase_products_modal')
<!-- /.content -->
@endsection
