...
<section class="content">
  ...
  {!! Form::open(['url' =>  action([\Modules\Accessory\Http\Controllers\PurchaseController::class, 'update'] , [$purchase->id] ), 'method' => 'PUT', 'id' => 'add_purchase_form', 'files' => true ]) !!}
  ...
  <input type="hidden" id="purchase_id" value="{{ $purchase->id }}">
    ...
    @component('accessory::components.widget', ['class' => 'box-primary'])
        ...
        <div class="row">
            <div class="col-sm-12">
              @include('accessory::purchase.partials.edit_purchase_entry_row')
