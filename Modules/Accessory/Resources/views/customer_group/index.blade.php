...
@section('content')
    ...
    <section class="content">
        @component('accessory::components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_your_customer_groups')])
            @can('customer.create')
                @slot('tool')
                    <div class="box-tools">
                        <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full btn-modal"
                            data-href="{{ action([\Modules\Accessory\Http\Controllers\CustomerGroupController::class, 'create']) }}"
            ...
            @can('customer.view')
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="customer_groups_table" data-href="{{ action([\Modules\Accessory\Http\Controllers\CustomerGroupController::class, 'index']) }}">
                        <thead>
                            <tr>
