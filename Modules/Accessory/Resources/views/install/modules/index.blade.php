...
<section class="content-header">
    ...
    <a class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm pull-right tw-mt-4" href="{{action([\Modules\Accessory\Http\Controllers\Install\ModulesController::class, 'regenerate'])}}">
...
<div class="row">
    <div class="col-md-12 form_col" style="display: none;">
        @component('accessory::components.widget')
            {!! Form::open(['url' => action([\Modules\Accessory\Http\Controllers\Install\ModulesController::class, 'uploadModule']), 'id' => 'upload_module_form','files' => true, 'style' => 'display:none']) !!}
                <div class="row">
                    <div class="col-md-5">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            ...
                            @if($module['active'] == 1)
                                <form 
                                    action="{{action([\Modules\Accessory\Http\Controllers\Install\ModulesController::class, 'update'], ['module_name' => $module['name']])}}" 
                            ...
                            @else
                                <form action="{{action([\Modules\Accessory\Http\Controllers\Install\ModulesController::class, 'update'], ['module_name' => $module['name']])}}" 
                                    style="display: inline;" 
                                    method="post"
                                >
                                    @method('PUT')
                        ...
                        <form 
                            action="{{action([\Modules\Accessory\Http\Controllers\Install\ModulesController::class, 'destroy'], ['module_name' => $module['name']])}}"
                                style="display: inline;" 
                                method="post"
