@extends('accessory::layouts.install', ['no_header' => 1])
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          <hr/>
          @include('accessory::install.partials.nav', ['active' => 'server'])
          ...
          <div class="box box-primary active" id="Installation">
            ...
            <div class="box-body">
              ...
              <br/>
              <a href="{{route('accessory.install.index')}}" class="btn btn-default pull-left">Back</a>

              <a @if($output['next']) href="{{route('accessory.install.details')}}" @endif class="btn btn-primary pull-right @if(!$output['next']) disabled-link @endif" @if(!$output['next']) disabled onclick="return false;" @endif>Next</a>
            </div>
          <!-- /.box-body -->
          </div>
        </div>
