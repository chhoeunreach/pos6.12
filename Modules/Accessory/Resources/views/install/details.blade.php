...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          <hr/>
          @include('accessory::install.partials.nav', ['active' => 'app_details'])
          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              <form class="form" id="details_form" method="post" 
                      action="{{route('accessory.install.postDetails')}}">
                  {{ csrf_field() }}
                ...
                <div class="col-md-4">
                  ...
                  <div class="col-md-12">
                    <a href="{{route('accessory.install.index')}}" class="btn btn-default pull-left back_button" tabindex="-1">Back</a>
