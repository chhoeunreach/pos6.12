        ...
        <div class="col-md-12">
            <div class="box box-primary" id="accordion">
              ...
              <div id="collapseFilter" class="panel-collapse active collapse in" aria-expanded="true">
                <div class="box-body">
                    <div class="row">
                        {!! Form::open(['url' => action([\Modules\Accessory\Http\Controllers\ReportController::class, 'productStockDetails']), 'method' => 'get' ]) !!}
                        <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            @foreach($stock_details as $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{action([\Modules\Accessory\Http\Controllers\ReportController::class, 'adjustProductStock'])}}?location_id={{$location->id}}&variation_id={{$row->variation_id}}&stock={{$row->total_stock_calculated}}" class="btn btn-primary">Fix</a>
                                    </td>
                                </tr>
                            @endforeach
                            </table>
