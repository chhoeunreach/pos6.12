        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($selectBase)
                ...
                ->editColumn('lot_number', function ($row) {
                    return '<a href="' . route('ssi.lot.history', $row->lot_number) . '" target="_blank">' . e($row->lot_number) . '</a>';
                })
                ->addColumn('action', function ($row) {
                    return '<a class="btn btn-xs btn-info" href="' . route('ssi.lot.history', $row->lot_number) . '" target="_blank"><i class="fa fa-history"></i> History</a>';
                })
