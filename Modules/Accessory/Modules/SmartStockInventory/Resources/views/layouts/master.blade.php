    ...
    $menuGroups = [
        [
            ...
            'items' => [
                ...
                ['label' => 'Stock Sell Report', 'url' => route('ssi.report.stock_sell'), 'active' => ['smart-stock-inventory/stock-reports/sell']],
                ['label' => 'Stock Purchase Report', 'url' => route('ssi.report.stock_purchase'), 'active' => ['smart-stock-inventory/stock-reports/purchase']],
                ['label' => 'Stock Transfer Report', 'url' => route('ssi.report.stock_transfer'), 'active' => ['smart-stock-inventory/stock-reports/transfer']],
