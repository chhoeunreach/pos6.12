    ...
    $menuGroups = [
        [
            ...
            'items' => [
                ...
                ['label' => 'Stock Purchase Return Report', 'url' => $ssiRoute('ssi.report.stock_purchaser_return'), 'active' => ['smart-stock-inventory/stock-reports/purchaser-return']],
                ['label' => 'Stock Sell Return Report', 'url' => $ssiRoute('ssi.report.stock_sell_return'), 'active' => ['smart-stock-inventory/stock-reports/sell-return']],
                ['label' => 'Stock Adjustment Report', 'url' => $ssiRoute('ssi.report.stock_adjustment'), 'active' => ['smart-stock-inventory/stock-reports/adjustment']],
                ['label' => 'HR Sell List Report', 'url' => $ssiRoute('ssi.report.hr_sell_list'), 'active' => ['smart-stock-inventory/hr-sell-list']],
