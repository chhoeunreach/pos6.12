...
<div class="box-body">
<form method="get" action="{{ ssi_route('ssi.mismatch.index') }}">
<div class="row">
...
<a class="btn btn-default" href="{{ ssi_route('ssi.mismatch.index') }}">Clear</a>
</div>
</div>
</form>
</div>
...
<form method="post" action="{{ ssi_route('ssi.mismatch.fix_auto') }}">@csrf
