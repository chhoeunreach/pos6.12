...
<div class="col-md-4 text-right"><button class="btn btn-primary">Filter</button> <a class="btn btn-success" href="{{ ssi_route('ssi.verification.export', request()->all()) }}">Export</a> <a class="btn btn-default" href="{{ ssi_route('ssi.verification.print', request()->all()) }}">Print</a></div>
</form>
</div></div>
<div class="row">
