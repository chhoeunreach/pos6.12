...
<div class="box box-warning"><div class="box-header"><h4>Session: {{ $session->name }}</h4><div class="pull-right"><a class="btn btn-success btn-sm" href="{{ ssi_route('ssi.count.enterprise.adjustment_preview', ['session'=>$session->id,'export'=>1]) }}">Export Preview</a></div></div>
...
<div class="box-footer"><button class="btn btn-success">Approve Adjustment</button> <a class="btn btn-default" href="{{ ssi_route('ssi.count.enterprise') }}">Cancel</a></div>
</div>
@endsection
