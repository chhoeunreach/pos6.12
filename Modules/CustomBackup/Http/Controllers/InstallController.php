...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'custombackup';
        $this->appVersion = config('custombackup.module_version', '1.0.0');
        $this->module_display_name = 'CustomBackup';
    }
    ...
    public function install()
    {
        ...
        try {
            ...
            // No module-specific migrations (feature uses core migrations).
            // Still publish module assets/config.
            try {
                Artisan::call('module:publish', ['module' => 'CustomBackup', '--force' => true]);
            } catch (\Throwable $e) {
            ...
            $output = ['success' => 1, 'msg' => 'CustomBackup module installed successfully'];
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['success' => 1, 'msg' => 'CustomBackup module updated successfully to version ' . $this->appVersion];
        } catch (\Exception $e) {
            $output = ['success' => false, 'msg' => $e->getMessage()];
        }
