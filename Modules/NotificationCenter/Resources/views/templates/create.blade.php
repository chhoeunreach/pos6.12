...
<div class="tw-px-3 lg:tw-px-5 tw-mx-auto tw-max-w-3xl">
    ...
    <form action="{{ route('notificationcenter.templates.store') }}" method="POST" class="tw-bg-white tw-rounded-lg tw-shadow-sm tw-border tw-p-6 tw-space-y-4">
        ...
        <div>
            ...
            <input type="text" name="title" value="{{ old('title') }}" required class="tw-w-full tw-border tw-border-gray-300 tw-rounded-lg tw-px-3 tw-py-2 tw-text-sm" placeholder="e.g. Stock Transfer Notification">
        ...
        <div>
            ...
            <input type="text" name="pdf_template_view" value="{{ old('pdf_template_view') }}" class="tw-w-full tw-border tw-border-gray-300 tw-rounded-lg tw-px-3 tw-py-2 tw-text-sm" placeholder="e.g. pdf.stock_transfer">
