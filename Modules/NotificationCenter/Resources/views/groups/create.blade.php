...
<div class="tw-px-3 lg:tw-px-5 tw-mx-auto tw-max-w-3xl">
    ...
    <form action="{{ route('notificationcenter.groups.store') }}" method="POST" class="tw-bg-white tw-rounded-lg tw-shadow-sm tw-border tw-p-6 tw-space-y-4">
        ...
        <div>
            ...
            <input type="text" name="name" required class="tw-w-full tw-border tw-border-gray-300 tw-rounded-lg tw-px-3 tw-py-2 tw-text-sm" placeholder="e.g. Main Stock Channel">
        </div>
        <div>
            <label class="tw-block tw-text-sm tw-font-medium tw-text-gray-700">Chat ID</label>
            <input type="text" name="chat_id" required class="tw-w-full tw-border tw-border-gray-300 tw-rounded-lg tw-px-3 tw-py-2 tw-text-sm" placeholder="e.g. -1001234567890">
        ...
        <div>
            ...
            <input type="number" name="location_id" class="tw-w-full tw-border tw-border-gray-300 tw-rounded-lg tw-px-3 tw-py-2 tw-text-sm" placeholder="Leave empty for all locations">
        </div>
