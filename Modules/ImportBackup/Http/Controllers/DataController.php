...
class DataController extends Controller
{
    public function modifyAdminMenu()
    {
        ...
        Menu::modify('admin-sidebar-menu', function ($menu) {
            $menu->url(
                action([\Modules\CustomBackup\Http\Controllers\CustomBackupController::class, 'showImportForm']),
                'Import Backup',
                [
                ...
                <path d="M22 19l-3 -3l-3 3"></path>
                    ...
                    'active' => request()->segment(1) == 'custom-backup' && request()->segment(2) == 'import',
                ]
            )->order(61);
        });
    }
