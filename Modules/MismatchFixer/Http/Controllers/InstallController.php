...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'mismatchfixer';
        $this->appVersion = config('mismatchfixer.module_version', '1.0.0');
        $this->module_display_name = 'MismatchFixer';
    }
    ...
    public function install()
    {
        ...
        try {
            ...
            Artisan::call('module:migrate', ['module' => 'MismatchFixer', '--force' => true]);
