...
<div class="col-md-6" style="padding-top:24px;"><button class="btn btn-primary">Filter</button> <a class="btn btn-default" href="{{ route('hr-sell.sales.index') }}">Reset</a> <a class="btn btn-success" href="{{ route('hr-sell.reports.index', request()->except('mode')) }}">Full Report</a></div>
</div>
</form>
</div></div>
...
<table class="table table-bordered table-striped" id="hr_sell_table"><thead><tr><th>Invoice</th><th>Date</th><th>Customer</th><th>HR Staff</th><th>Status</th><th>Total</th><th>Paid</th><th>Due</th><th>Commission</th><th>Approval</th><th>Follow-up</th><th>Action</th></tr></thead><tbody>
