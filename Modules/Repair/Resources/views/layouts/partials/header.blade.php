	...
	@can("repair.create")
		@if(function_exists('repair_is_service_context') && repair_is_service_context())
			@include('service::layouts.partials.header-action-button', [
				...
				'icon' => 'repair',
				'label' => __('repair::lang.repair'),
				'attributes' => [
					'title' => __('repair::lang.add_repair'),
					'data-toggle' => 'tooltip',
					'data-placement' => 'bottom',
				],
			])
		@else
			<a href="{{ repair_route('pos.create', ['sub_type' => 'repair']) }}" title="{{ __('repair::lang.add_repair') }}" data-toggle="tooltip" data-placement="bottom"
