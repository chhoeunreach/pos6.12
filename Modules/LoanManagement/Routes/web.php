...
Route::middleware(['web', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin', 'loan.activity'])
    ...
    ->group(function () {
        ...
        Route::put('/telegram-chat-api/chats/{thread}/messages/{message}', [LoanTelegramChatController::class, 'updateMessage'])->name('loan-management.telegram-chat-api.messages.update')->middleware('loan.permission:loan_management.chat.reply|loan_management.chat.admin');
        Route::delete('/telegram-chat-api/chats/{thread}/messages/{message}', [LoanTelegramChatController::class, 'destroyMessage'])->name('loan-management.telegram-chat-api.messages.destroy')->middleware('loan.permission:loan_management.chat.delete|loan_management.chat.admin');
