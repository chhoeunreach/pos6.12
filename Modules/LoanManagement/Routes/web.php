...
Route::middleware(['web', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin', 'loan.user.sync', 'loan.activity'])
    ...
    ->group(function () {
        Route::middleware('loan.permission:loan_management.dashboard.view|loan_management.view')->group(function () {
        ...
        Route::match(['get', 'post'], '/language', [SettingsController::class, 'switchLanguage'])->middleware('loan.permission:loan_management.view|loan_management.settings.view|loan_management.setting')->name('loan-management.language.switch');

        Route::middleware('loan.permission:loan_management.admin_loan.view|loan_management.view')->group(function () {
        ...
        Route::post('/admin-loan/details/{loan}/update', [DashboardController::class, 'adminLoanInlineUpdate'])
            ->where(['loan' => '[0-9]+'])
            ->middleware('loan.permission:loan_management.admin_loan.edit|loan_management.edit')
            ->name('loan-management.admin-loan.details.update');

        Route::middleware('loan.permission:loan_management.collection.view|loan_management.view')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.loans.create|loan_management.create')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.loans.create|loan_management.loans.edit|loan_management.create|loan_management.edit')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.loans.view|loan_management.view')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.loans.edit|loan_management.edit')->group(function () {
        ...
        Route::delete('/loans/{loan}', [LoanInstallmentListController::class, 'destroy'])->middleware('loan.permission:loan_management.loans.delete|loan_management.delete')->name('loan-management.loans.destroy');
        Route::post('/loans/{loan}/status', [LoanInstallmentListController::class, 'changeStatus'])->middleware('loan.permission:loan_management.loans.approve|loan_management.approve')->name('loan-management.loans.status');
        Route::get('/loans/{loan}/convert-to-pos', [LoanInstallmentListController::class, 'convertToPos'])->middleware('loan.permission:loan_management.sell_convert|loan_management.edit')->name('loan-management.loans.convert-to-pos');
        Route::middleware('loan.permission:loan_management.payments.create|loan_management.payment|loan_management.view')->group(function () {
        ...
        Route::delete('/loans/{loan}/schedules/{schedule}', [LoanInstallmentListController::class, 'destroySchedule'])->where(['loan' => '[0-9]+', 'schedule' => '[0-9]+'])->middleware('loan.permission:loan_management.loans.edit|loan_management.delete')->name('loan-management.loans.schedules.destroy');
        Route::delete('/loans/{loan}/items/{item}', [LoanInstallmentListController::class, 'destroyItem'])->middleware('loan.permission:loan_management.loans.edit|loan_management.delete')->name('loan-management.loans.items.destroy');

        Route::middleware('loan.permission:loan_management.customers.view|loan_management.view')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.customers.create|loan_management.create')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.customers.edit|loan_management.edit')->group(function () {
        ...
        Route::post('/customers/{customer}/blacklist', [LoanCustomerController::class, 'blacklist'])->middleware('loan.permission:loan_management.blacklist.view|loan_management.edit')->name('loan-management.customers.blacklist');
        Route::post('/customers/{customer}/gps/enable', [LoanCustomerController::class, 'enableGpsTracking'])->middleware('loan.permission:loan_management.customer_gps.manage')->name('loan-management.customers.gps.enable');
        Route::post('/customers/{customer}/gps/disable', [LoanCustomerController::class, 'disableGpsTracking'])->middleware('loan.permission:loan_management.customer_gps.manage')->name('loan-management.customers.gps.disable');

        Route::middleware('loan.permission:loan_management.products.view|loan_management.view')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.products.create|loan_management.create')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.products.edit|loan_management.edit')->group(function () {
        ...
        Route::delete('/products/{product}', [LoanProductController::class, 'destroy'])->middleware('loan.permission:loan_management.products.delete|loan_management.delete')->name('loan-management.products.destroy');

        Route::middleware('loan.permission:loan_management.customer_gps.manage|loan_management.gps.view')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.payments.view|loan_management.payment|loan_management.view')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.payment|loan_management.edit')->group(function () {
        ...
        Route::delete('/payments/{payment}', [LoanPaymentController::class, 'destroy'])->middleware('loan.permission:loan_management.payment|loan_management.delete')->name('loan-management.payments.destroy');
        ...
        Route::post('/chat-api/chats/{thread}/close', [LoanChatController::class, 'close'])->middleware('loan.permission:loan_management.chat.close')->name('loan-management.chat-api.close');
        ...
        Route::get('/activity-logs', [LoanActivityLogController::class, 'index'])->middleware('loan.permission:loan_management.setting|loan_management.view')->name('loan-management.activity-logs.index');

        Route::middleware('loan.permission:user.view|user.create')->group(function () {
        ...
        Route::middleware('loan.permission:user.create')->group(function () {
        ...
        Route::middleware('loan.permission:user.update')->group(function () {
        ...
        Route::delete('/users/{user}', [LoanUserController::class, 'destroy'])->where(['user' => '[0-9]+'])->middleware('loan.permission:user.delete')->name('loan-management.users.destroy');

        Route::middleware('loan.permission:roles.view|roles.create')->group(function () {
        ...
        Route::middleware('loan.permission:roles.create')->group(function () {
        ...
        Route::middleware('loan.permission:roles.update')->group(function () {
        ...
        Route::delete('/roles/{role}', [LoanRoleController::class, 'destroy'])->where(['role' => '[0-9]+'])->middleware('loan.permission:roles.delete')->name('loan-management.roles.destroy');

        Route::middleware('loan.permission:loan_management.import.view|loan_management.export.view|loan_management.view')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.import.view')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.schedules.view|loan_management.view')->group(function () {
        ...
        Route::get('/monthly-payments', [DashboardController::class, 'placeholder'])->middleware('loan.permission:loan_management.monthly_payments.view|loan_management.view')->defaults('page', 'Monthly Payments')->name('loan-management.monthly-payments.index');
        Route::get('/overdue', [DashboardController::class, 'overdue'])->middleware('loan.permission:loan_management.overdue.view|loan_management.view')->name('loan-management.overdue.index');
        Route::get('/collection-visits', [DashboardController::class, 'collectionVisits'])->middleware('loan.permission:loan_management.collection_visits.view|loan_management.collection.view|loan_management.view')->name('loan-management.collection-visits.index');
        Route::get('/gps', [AdminCustomerTrackingController::class, 'index'])->middleware('loan.permission:loan_management.gps.view|loan_management.customer_gps.manage')->name('loan-management.gps.index');
        Route::get('/finance/aba-transactions', [DashboardController::class, 'placeholder'])->middleware('loan.permission:loan_management.aba.view|loan_management.view')->defaults('page', 'ABA Transactions')->name('loan-management.aba.index');
        Route::get('/aba', [DashboardController::class, 'placeholder'])->middleware('loan.permission:loan_management.aba.view|loan_management.view')->defaults('page', 'ABA Transactions')->name('loan-management.aba');
        Route::middleware('loan.permission:loan_management.reports.view|loan_management.report|loan_management.view')->group(function () {
        ...
        Route::middleware('loan.permission:loan_management.blacklist.view|loan_management.view')->group(function () {
        ...
        Route::post('/blacklist', [LoanCustomerController::class, 'blacklistStore'])->middleware('loan.permission:loan_management.blacklist.view|loan_management.edit')->name('loan-management.blacklist.store');
    });
