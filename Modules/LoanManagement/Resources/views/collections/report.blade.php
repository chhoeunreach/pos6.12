...
<div class="lm-col-content">
    <section class="content-header" style="padding: 0 0 16px 0; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 12px;">
        ...
        <a href="{{ route('loan-management.collection.reports') }}" class="btn btn-default btn-sm" style="font-weight: 600; border-radius: 6px;">
            <i class="fa fa-arrow-left"></i> {{ $lmText('Back to Reports Hub', 'ត្រឡប់ទៅមជ្ឈមណ្ឌលរបាយការណ៍') }}
        </a>
    </section>
    ...
    <div class="lm-col-summary-grid">
        <div class="lm-col-card lm-col-blue">
            ...
            <div class="lm-col-copy">
                ...
                <span>{{ $lmText('Matching records', 'ទិន្នន័យកិច្ចសន្យា') }}</span>
            </div>
        </div>
        ...
        <div class="lm-col-card lm-col-purple">
            ...
            <div class="lm-col-copy">
                ...
                <span>{{ $lmText('Priority follow-up', 'ត្រូវការតាមដាន') }}</span>
            </div>
        </div>
        @endif
    </div>
