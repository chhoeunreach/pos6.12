<div class="row">
    ...
    <div class="col-md-4"><div class="form-group"><label>Khmer Name (Primary)</label><input class="form-control" name="khmer_name" value="{{ old('khmer_name', $customerRow->khmer_name ?? '') }}"></div></div>
    <div class="col-md-4"><div class="form-group"><label>English Name *</label><input class="form-control" name="name" required value="{{ old('name', $customerRow->name ?? '') }}"></div></div>
