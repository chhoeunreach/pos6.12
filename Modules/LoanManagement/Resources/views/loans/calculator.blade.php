...
<script>
    (function($) {
        ...
        function recalculateLoan() {
            ...
            $('#calc_interest_result').text(money(interestPerMonth));
            $('#calc_monthly_result').text(money(principalPerMonth + interestPerMonth));
        ...
        $(document).off('input.loanCalculator change.loanCalculator', '#loanCalculatorForm input')
            .on('input.loanCalculator change.loanCalculator', '#loanCalculatorForm input', recalculateLoan);
