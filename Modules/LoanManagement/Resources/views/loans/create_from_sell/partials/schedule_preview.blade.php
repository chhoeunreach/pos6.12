        ...
        <table class="table table-bordered" id="schedulePreviewTable">
            ...
            <tfoot>
                <tr>
                    ...
                    <th class="schedule-total-principal">0.00</th>
                    <th class="schedule-total-interest">0.00</th>
                    <th class="schedule-total-amount">0.00</th>
                    <th class="schedule-total-balance">0.00</th>
                </tr>
            </tfoot>
        </table>
    </div>
