<div class="box box-warning">
    ...
    <div class="box-body row">
        ...
        <div class="col-sm-6 col-md-3"><div class="form-group"><label>Duration Months</label><input type="number" name="duration_months" class="form-control" value="{{ $sell['defaults']['duration_months'] }}"></div></div>
