<div class="box box-warning">
    ...
    <div class="box-body row">
        ...
        <div class="col-sm-6 col-md-3"><div class="form-group"><label>Interest Type</label><select name="interest_type" class="form-control"><option value="flat" {{ old('interest_type', $sell['defaults']['interest_type'] ?? 'flat') === 'flat' ? 'selected' : '' }}>Flat</option><option value="reducing" {{ old('interest_type', $sell['defaults']['interest_type'] ?? 'flat') === 'reducing' ? 'selected' : '' }}>Reducing</option></select></div></div>
