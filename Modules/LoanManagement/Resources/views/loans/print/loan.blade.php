...
<div class="page">
    ...
    <div class="notice">
        <span class="title">ចំណាំ:</span>
        ខ្ញុំទទួលស្គាល់ថាត្រូវបង់ប្រាក់អោយបានទៀងទាត់។ ក្នុងករណីយឺតយ៉ាវ អាចមានការពិន័យតាមគោលការណ៍ហាង។
        <br>
        <span class="red bold">សម្រាប់ការធានា និងលក្ខខណ្ឌផ្សេងៗ សូមទាក់ទងមកកាន់ហាងដោយផ្ទាល់។</span>
    </div>
    ...
    <div class="footer-bold">
        សេវាកម្ម៖ សូមទំនាក់ទំនងមកកាន់ Telegram លេខ 0717221349 រាល់ពេលបង់ប្រាក់
    </div>
</div>
