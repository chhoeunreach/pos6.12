    ...
    $menuSections = [
        [
            'items' => [
                ...
                ['label' => $lmText('Admin Loan', 'រដ្ឋបាលកម្ចី'), 'icon' => 'fa fa-table', 'route' => 'loan-management.admin-loan', 'can' => 'loan_management.admin_loan.view|loan_management.view', 'tone' => 'cyan'],
        ...
        [
            ...
            'items' => [
                ['label' => $lmText('Customers', 'អតិថិជន'), 'icon' => 'fa fa-users', 'route' => 'loan-management.customers', 'can' => 'loan_management.customers.view|loan_management.view', 'tone' => 'green'],
        ...
        [
            ...
            'items' => [
                ['label' => $lmText("Today's Collection", 'ប្រមូលប្រាក់ថ្ងៃនេះ'), 'icon' => 'fa fa-usd', 'route' => 'loan-management.operations.page', 'params' => ['page' => 'today-collection'], 'can' => 'loan_management.collection.view|loan_management.view', 'tone' => 'violet'],
                ['label' => $lmText('Payments', 'ការបង់ប្រាក់'), 'icon' => 'fa fa-money', 'route' => 'loan-management.payments.index', 'can' => 'loan_management.payments.view|loan_management.payment|loan_management.view', 'tone' => 'violet'],
                ['label' => $lmText('Overdue', 'ហួសកំណត់'), 'icon' => 'fa fa-exclamation-triangle', 'route' => 'loan-management.collection.page', 'params' => ['page' => 'overdue-accounts'], 'can' => 'loan_management.overdue.view|loan_management.collection.view|loan_management.view', 'badge' => $badgeCounts['overdue'] ?? 0, 'tone' => 'red'],
                ['label' => $lmText('Collection Cases', 'ករណីប្រមូលប្រាក់'), 'icon' => 'fa fa-shield', 'tone' => 'violet', 'children' => [
                    ['label' => $lmText('Promise To Pay', 'សន្យាបង់ប្រាក់'), 'route' => 'loan-management.collection.page', 'params' => ['page' => 'promise-to-pay'], 'can' => 'loan_management.collection.view|loan_management.view'],
                    ['label' => $lmText('Broken Promise', 'ខកខានសន្យា'), 'route' => 'loan-management.collection.page', 'params' => ['page' => 'broken-promise'], 'can' => 'loan_management.collection.view|loan_management.view'],
                    ['label' => $lmText('Delinquent Accounts', 'គណនីយឺតយ៉ាវ'), 'route' => 'loan-management.collection.page', 'params' => ['page' => 'delinquent-accounts'], 'can' => 'loan_management.collection.view|loan_management.view'],
                    ['label' => $lmText('Recovery Management', 'គ្រប់គ្រងការស្ដារបំណុល'), 'route' => 'loan-management.collection.page', 'params' => ['page' => 'recovery-management'], 'can' => 'loan_management.collection.recovery|loan_management.collection.view|loan_management.view'],
                    ['label' => $lmText('Debt Collection', 'ប្រមូលបំណុល'), 'route' => 'loan-management.collection.page', 'params' => ['page' => 'debt-collection'], 'can' => 'loan_management.collection.view|loan_management.view'],
                ]],
                ['label' => $lmText('Field Visits', 'ចុះជួបអតិថិជន'), 'icon' => 'fa fa-map-marker', 'route' => 'loan-management.collection-visits.index', 'can' => 'loan_management.collection_visits.view|loan_management.collection.view|loan_management.view', 'badge' => $badgeCounts['pending_visits'] ?? 0, 'tone' => 'violet'],
            ],
        ],
        [
            'label' => $lmText('Finance', 'ហិរញ្ញវត្ថុ'),
            'items' => [
                ['label' => $lmText('Cash & Bank', 'សាច់ប្រាក់ និងធនាគារ'), 'icon' => 'fa fa-bank', 'route' => 'loan-management.payments.index', 'params' => ['payment_type' => 'loan'], 'can' => 'loan_management.payments.view|loan_management.payment|loan_management.view', 'tone' => 'cyan'],
                ['label' => $lmText('Income', 'ចំណូល'), 'icon' => 'fa fa-level-up', 'route' => 'loan-management.payments.index', 'params' => ['payment_type' => 'monthly'], 'can' => 'loan_management.payments.view|loan_management.payment|loan_management.view', 'tone' => 'cyan'],
            ],
        ],
        [
        ...
        [
            ...
            'items' => [
                ...
                ['label' => $lmText('Branches', 'សាខា'), 'icon' => 'fa fa-building-o', 'route' => 'loan-management.locations.index', 'can' => 'loan_management.settings.view|loan_management.setting|loan_management.view', 'tone' => 'blue'],
