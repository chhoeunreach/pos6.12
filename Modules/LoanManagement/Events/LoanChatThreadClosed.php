...
class LoanChatThreadClosed implements ShouldBroadcastNow
{
    use Dispatchable;
    ...
    public function broadcastOn(): array
    {
        ...
        if ($this->thread->customer_id) {
            $channels[] = new PrivateChannel('loan-chat.customer.'.$this->thread->customer_id);
        }
