    ...
    */
    ...
    'connections' => [
        ...
        'mysql_loan' => [
            ...
            'database' => env('DB_LOAN_DATABASE', 's_loanmanagement'),
            'username' => env('DB_LOAN_USERNAME') ?: env('DB_USERNAME', 'forge'),
            'password' => env('DB_LOAN_PASSWORD') ?: env('DB_PASSWORD', ''),
        ...
        'accessory' => [
            ...
            'database' => env('ACCESSORY_DB_DATABASE', 's_accessory'),
            'username' => env('ACCESSORY_DB_USERNAME') ?: env('DB_USERNAME', 'forge'),
            'password' => env('ACCESSORY_DB_PASSWORD') ?: env('DB_PASSWORD', ''),
        ...
        'service' => [
            ...
            'database' => env('SERVICE_DB_DATABASE', 's_services'),
            'username' => env('SERVICE_DB_USERNAME') ?: env('DB_USERNAME', 'forge'),
            'password' => env('SERVICE_DB_PASSWORD') ?: env('DB_PASSWORD', ''),
